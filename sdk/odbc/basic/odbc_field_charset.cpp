...
#endif
{
    ...
    switch (_data_type) {
...
#endif
        {
            ...
            TCHAR TSTRING_FORMAT_DATETIME_YMD[] = {
                _T('%'), _T('d'), _T('-'), _T('%'), _T('0'), _T('2'), _T('d'), _T('-'), _T('%'), _T('0'), _T('2'), _T('d'), _T(' '), _T('%'), _T('0'), _T('2'),
                _T('d'), _T(':'), _T('%'), _T('0'), _T('2'), _T('d'), _T(':'), _T('%'), _T('0'), _T('2'), _T('d'), _T('.'), _T('%'), _T('d'), 0,
            };
            TCHAR tchDate[256];
            _sntprintf(tchDate, 256, TSTRING_FORMAT_DATETIME_YMD, dt.year, dt.month, dt.day, dt.hour, dt.minute, dt.second, dt.milliseconds / 1000000);
            str = tchDate;
        } break;
        default:
            if (nullptr != _field_data.p) {
