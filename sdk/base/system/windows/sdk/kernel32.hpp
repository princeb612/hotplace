...
#define DECLARE_NAMEOF_API_INTERLOCKEDINCREMENT CHAR NAMEOF_API_INTERLOCKEDINCREMENT[] = { 'I', 'n', 't', 'e', 'r', 'l', 'o', 'c', 'k', 'e', 'd', 'I', 'n', 'c', 'r', 'e', 'm', 'e', 'n', 't', 0, };
/* "InterlockedDecrement" */
#define DECLARE_NAMEOF_API_INTERLOCKEDDECREMENT CHAR NAMEOF_API_INTERLOCKEDDECREMENT[] = { 'I', 'n', 't', 'e', 'r', 'l', 'o', 'c', 'k', 'e', 'd', 'D', 'e', 'c', 'r', 'e', 'm', 'e', 'n', 't', 0, };
/* "InterlockedCompareExchange" */
#define DECLARE_NAMEOF_API_INTERLOCKEDCOMPAREEXCHANGE CHAR NAMEOF_API_INTERLOCKEDCOMPAREEXCHANGE[] = { 'I', 'n', 't', 'e', 'r', 'l', 'o', 'c', 'k', 'e', 'd', 'C', 'o', 'm', 'p', 'a', 'r', 'e', 'E', 'x', 'c', 'h', 'a', 'n', 'g', 'e', 0, };
/* "InterlockedExchange" */
#define DECLARE_NAMEOF_API_INTERLOCKEDEXCHANGE CHAR NAMEOF_API_INTERLOCKEDEXCHANGE[] = { 'I', 'n', 't', 'e', 'r', 'l', 'o', 'c', 'k', 'e', 'd', 'E', 'x', 'c', 'h', 'a', 'n', 'g', 'e', 0, };
 ...
 */
typedef LONG (__stdcall* INTERLOCKEDINCREMENT)
(
 ...
 */
typedef LONG (__stdcall* INTERLOCKEDDECREMENT)
(
    __inout LONG volatile* Addend
);
/* @brief
 ...
 */
typedef LONG (__stdcall* INTERLOCKEDCOMPAREEXCHANGE)
(
    __inout LONG volatile * Destination,
    ___in LONG Exchange,
    ___in LONG Comperand
);
/* @brief
 ...
 */
typedef LONG (__stdcall* INTERLOCKEDEXCHANGE)
(
...
#define DECLARE_NAMEOF_API_INITIALIZECRITICALSECTIONANDSPINCOUNT CHAR NAMEOF_API_INITIALIZECRITICALSECTIONANDSPINCOUNT[] = { 'I', 'n', 'i', 't', 'i', 'a', 'l', 'i', 'z', 'e', 'C', 'r', 'i', 't', 'i', 'c', 'a', 'l', 'S', 'e', 'c', 't', 'i', 'o', 'n', 'A', 'n', 'd', 'S', 'p', 'i', 'n', 'C', 'o', 'u', 'n', 't', 0, };
/* "TryEnterCriticalSection" */
#define DECLARE_NAMEOF_API_TRYENTERCRITICALSECTION CHAR NAMEOF_API_TRYENTERCRITICALSECTION[] = { 'T', 'r', 'y', 'E', 'n', 't', 'e', 'r', 'C', 'r', 'i', 't', 'i', 'c', 'a', 'l', 'S', 'e', 'c', 't', 'i', 'o', 'n', 0, };
 ...
 */
typedef BOOL (__stdcall* INITIALIZECRITICALSECTIONANDSPINCOUNT)
(
 ...
 */
typedef BOOL (__stdcall* TRYENTERCRITICALSECTION)
(
    LPCRITICAL_SECTION lpCriticalSection
);
...
/* "FindFirstFileA" */
#define DECLARE_NAMEOF_API_FINDFIRSTFILEA CHAR NAMEOF_API_FINDFIRSTFILEA[] = { 'F', 'i', 'n', 'd', 'F', 'i', 'r', 's', 't', 'F', 'i', 'l', 'e', 'A', 0, };
/* "FindFirstFileW" */
#define DECLARE_NAMEOF_API_FINDFIRSTFILEW CHAR NAMEOF_API_FINDFIRSTFILEW[] = { 'F', 'i', 'n', 'd', 'F', 'i', 'r', 's', 't', 'F', 'i', 'l', 'e', 'W', 0, };
/* "FindNextFileA" */
#define DECLARE_NAMEOF_API_FINDNEXTFILEA CHAR NAMEOF_API_FINDNEXTFILEA[] = { 'F', 'i', 'n', 'd', 'N', 'e', 'x', 't', 'F', 'i', 'l', 'e', 'A', 0, };
/* "FindNextFileW" */
#define DECLARE_NAMEOF_API_FINDNEXTFILEW CHAR NAMEOF_API_FINDNEXTFILEW[] = { 'F', 'i', 'n', 'd', 'N', 'e', 'x', 't', 'F', 'i', 'l', 'e', 'W', 0, };
/* "FindClose" */
#define DECLARE_NAMEOF_API_FINDCLOSE CHAR NAMEOF_API_FINDCLOSE[] = { 'F', 'i', 'n', 'd', 'C', 'l', 'o', 's', 'e', 0, };
...
(
    ___in LPCSTR lpFileName,
    ___out LPWIN32_FIND_DATAA lpFindFileData
);
typedef HANDLE (__stdcall *FINDFIRSTFILEW)
(
    ___in LPCWSTR lpFileName,
    ___out LPWIN32_FIND_DATAW lpFindFileData
);
/* @brief
...
(
    ___in HANDLE hFindFile,
    ___out LPWIN32_FIND_DATAA lpFindFileData
);
typedef BOOL (__stdcall *FINDNEXTFILEW)
(
    ___in HANDLE hFindFile,
    ___out LPWIN32_FIND_DATAW lpFindFileData
);
 ...
 */
typedef BOOL (__stdcall *FINDCLOSE)
(
...
/* "ReadFileEx" */
#define DECLARE_NAMEOF_API_READFILEEX CHAR NAMEOF_API_READFILEEX[] = { 'R', 'e', 'a', 'd', 'F', 'i', 'l', 'e', 'E', 'x', 0, };
/* "WriteFileEx" */
#define DECLARE_NAMEOF_API_WRITEFILEEX CHAR NAMEOF_API_WRITEFILEEX[] = { 'W', 'r', 'i', 't', 'e', 'F', 'i', 'l', 'e', 'E', 'x', 0, };
 ...
 */
typedef BOOL (__stdcall* READFILEEX)
(
    HANDLE hFile,
    LPVOID lpBuffer,
 ...
 */
typedef BOOL (__stdcall* WRITEFILEEX)
(
    HANDLE hFile,
    LPCVOID lpBuffer,
...
#define DECLARE_NAMEOF_API_CREATETOOLHELP32SNAPSHOT CHAR NAMEOF_API_CREATETOOLHELP32SNAPSHOT[] = { 'C', 'r', 'e', 'a', 't', 'e', 'T', 'o', 'o', 'l', 'h', 'e', 'l', 'p', '3', '2', 'S', 'n', 'a', 'p', 's', 'h', 'o', 't', 0, };
...
#endif
/* "Process32First" */
#define DECLARE_NAMEOF_API_PROCESS32FIRSTA CHAR NAMEOF_API_PROCESS32FIRSTA[] = { 'P', 'r', 'o', 'c', 'e', 's', 's', '3', '2', 'F', 'i', 'r', 's', 't', 0, };
/* "Process32FirstW" */
#define DECLARE_NAMEOF_API_PROCESS32FIRSTW CHAR NAMEOF_API_PROCESS32FIRSTW[] = { 'P', 'r', 'o', 'c', 'e', 's', 's', '3', '2', 'F', 'i', 'r', 's', 't', 'W', 0, };
/* "Process32Next" */
#define DECLARE_NAMEOF_API_PROCESS32NEXTA CHAR NAMEOF_API_PROCESS32NEXTA[] = { 'P', 'r', 'o', 'c', 'e', 's', 's', '3', '2', 'N', 'e', 'x', 't', 0, };
/* "Process32NextW" */
#define DECLARE_NAMEOF_API_PROCESS32NEXTW CHAR NAMEOF_API_PROCESS32NEXTW[] = { 'P', 'r', 'o', 'c', 'e', 's', 's', '3', '2', 'N', 'e', 'x', 't', 'W', 0, };

/* @brief
    Retrieves information about the first process encountered in a system snapshot.
 */
typedef BOOL (__stdcall *PROCESS32FIRSTA)
(
    HANDLE,
    LPPROCESSENTRY32
);
typedef BOOL (__stdcall *PROCESS32FIRSTW)
(
    HANDLE,
    LPPROCESSENTRY32W
);
 ...
 */
typedef BOOL (__stdcall *PROCESS32NEXTA)
(
    HANDLE,
    LPPROCESSENTRY32
);
typedef BOOL (__stdcall *PROCESS32NEXTW)
(
    HANDLE,
    LPPROCESSENTRY32W
);
...
/* "Module32First" */
#define DECLARE_NAMEOF_API_MODULE32FIRSTA CHAR NAMEOF_API_MODULE32FIRSTA[] = { 'M', 'o', 'd', 'u', 'l', 'e', '3', '2', 'F', 'i', 'r', 's', 't', 0, };
/* "Module32Next" */
#define DECLARE_NAMEOF_API_MODULE32NEXTA CHAR NAMEOF_API_MODULE32NEXTA[] = { 'M', 'o', 'd', 'u', 'l', 'e', '3', '2', 'N', 'e', 'x', 't', 0, };
/* "Module32FirstW" */
#define DECLARE_NAMEOF_API_MODULE32FIRSTW CHAR NAMEOF_API_MODULE32FIRSTW[] = { 'M', 'o', 'd', 'u', 'l', 'e', '3', '2', 'F', 'i', 'r', 's', 't', 'W', 0, };
/* "Module32NextW" */
#define DECLARE_NAMEOF_API_MODULE32NEXTW CHAR NAMEOF_API_MODULE32NEXTW[] = { 'M', 'o', 'd', 'u', 'l', 'e', '3', '2', 'N', 'e', 'x', 't', 'W', 0, };

/* @brief
    Retrieves information about the first module associated with a process.
 */
typedef BOOL (__stdcall *MODULE32FIRSTA)
(
    HANDLE hSnapshot,
    LPMODULEENTRY32 lpme
);
typedef BOOL (__stdcall *MODULE32FIRSTW)
(
    HANDLE hSnapshot,
 ...
 */
typedef BOOL (__stdcall *MODULE32NEXTA)
(
    HANDLE hSnapshot,
    LPMODULEENTRY32 lpme
);
typedef BOOL (__stdcall *MODULE32NEXTW)
(
    HANDLE hSnapshot,
    LPMODULEENTRY32W lpme
);
...
/* "OutputDebugStringA" */
#define DECLARE_NAMEOF_API_OUTPUTDEBUGSTRINGA CHAR NAMEOF_API_OUTPUTDEBUGSTRINGA[] = { 'O', 'u', 't', 'p', 'u', 't', 'D', 'e', 'b', 'u', 'g', 'S', 't', 'r', 'i', 'n', 'g', 'A', 0, };
/* "OutputDebugStringW" */
#define DECLARE_NAMEOF_API_OUTPUTDEBUGSTRINGW CHAR NAMEOF_API_OUTPUTDEBUGSTRINGW[] = { 'O', 'u', 't', 'p', 'u', 't', 'D', 'e', 'b', 'u', 'g', 'S', 't', 'r', 'i', 'n', 'g', 'W', 0, };
...
/* FormatMessage */
#define DECLARE_NAMEOF_API_FORMATMESSAGEA CHAR NAMEOF_API_FORMATMESSAGEA[] = { 'F', 'o', 'r', 'm', 'a', 't', 'M', 'e', 's', 's', 'a', 'g', 'e', 'A', 0, };
#define DECLARE_NAMEOF_API_FORMATMESSAGEW CHAR NAMEOF_API_FORMATMESSAGEW[] = { 'F', 'o', 'r', 'm', 'a', 't', 'M', 'e', 's', 's', 'a', 'g', 'e', 'W', 0, };
 ...
 */
typedef DWORD (__stdcall *FORMATMESSAGEA)
(
    ___in DWORD dwFlags,
    __in_opt LPCVOID lpSource,
    ___in DWORD dwMessageId,
    ___in DWORD dwLanguageId,
    ___out LPSTR lpBuffer,
    ___in DWORD nSize,
    __in_opt va_list * Arguments
);
typedef DWORD (__stdcall *FORMATMESSAGEW)
(
    ___in DWORD dwFlags,
    __in_opt LPCVOID lpSource,
    ___in DWORD dwMessageId,
    ___in DWORD dwLanguageId,
    ___out LPWSTR lpBuffer,
    ___in DWORD nSize,
    __in_opt va_list * Arguments
);

/* "GetNativeSystemInfo" */
#define DECLARE_NAMEOF_API_GETNATIVESYSTEMINFO CHAR NAMEOF_API_GETNATIVESYSTEMINFO[] = { 'G', 'e', 't', 'N', 'a', 't', 'i', 'v', 'e', 'S', 'y', 's', 't', 'e', 'm', 'I', 'n', 'f', 'o', 0, };
...
#define DECLARE_NAMEOF_API_GETUSERDEFAULTUILANGUAGE CHAR NAMEOF_API_GETUSERDEFAULTUILANGUAGE[] = { 'G', 'e', 't', 'U', 's', 'e', 'r', 'D', 'e', 'f', 'a', 'u', 'l', 't', 'U', 'I', 'L', 'a', 'n', 'g', 'u', 'a', 'g', 'e', 0, };
...
/* "VerifyVersionInfoA" */
#define DECLARE_NAMEOF_API_VERIFYVERSIONINFOA CHAR NAMEOF_API_VERIFYVERSIONINFOA[] = { 'V', 'e', 'r', 'i', 'f', 'y', 'V', 'e', 'r', 's', 'i', 'o', 'n', 'I', 'n', 'f', 'o', 'A', 0, };
/* "VerifyVersionInfoW" */
#define DECLARE_NAMEOF_API_VERIFYVERSIONINFOW CHAR NAMEOF_API_VERIFYVERSIONINFOW[] = { 'V', 'e', 'r', 'i', 'f', 'y', 'V', 'e', 'r', 's', 'i', 'o', 'n', 'I', 'n', 'f', 'o', 'W', 0, };
...
/* "GetProductInfo" */
#define DECLARE_NAMEOF_API_GETPRODUCTINFO CHAR NAMEOF_API_GETPRODUCTINFO[] = { 'G', 'e', 't', 'P', 'r', 'o', 'd', 'u', 'c', 't', 'I', 'n', 'f', 'o', 0, };
/* @brief
...
#define DECLARE_NAMEOF_API_GETPROCESSWORKINGSETSIZE CHAR NAMEOF_API_GETPROCESSWORKINGSETSIZE[] = { 'G', 'e', 't', 'P', 'r', 'o', 'c', 'e', 's', 's', 'W', 'o', 'r', 'k', 'i', 'n', 'g', 'S', 'e', 't', 'S', 'i', 'z', 'e', 0, };

/* @brief
    Retrieves the minimum and maximum working set sizes of the specified process.
 */
typedef BOOL (__stdcall* GETPROCESSWORKINGSETSIZE)
(
    ___in HANDLE hProcess,
    ___out PSIZE_T lpMinimumWorkingSetSize,
    ___out PSIZE_T lpMaximumWorkingSetSize
);

/* "SetProcessWorkingSetSize" */
#define DECLARE_NAMEOF_API_SETPROCESSWORKINGSETSIZE CHAR NAMEOF_API_SETPROCESSWORKINGSETSIZE[] = { 'S', 'e', 't', 'P', 'r', 'o', 'c', 'e', 's', 's', 'W', 'o', 'r', 'k', 'i', 'n', 'g', 'S', 'e', 't', 'S', 'i', 'z', 'e', 0, };
...
(
    ___in HANDLE hProcess,
    ___in SIZE_T dwMinimumWorkingSetSize,
    ___in SIZE_T dwMaximumWorkingSetSize
);
...
#define DECLARE_NAMEOF_API_GETSYSTEMWOW64DIRECTORYA CHAR NAMEOF_API_GETSYSTEMWOW64DIRECTORYA[] = { 'G', 'e', 't', 'S', 'y', 's', 't', 'e', 'm', 'W', 'o', 'w', '6', '4', 'D', 'i', 'r', 'e', 'c', 't', 'o', 'r', 'y', 'A', 0, };
/* "GetSystemWow64DirectoryW" */
#define DECLARE_NAMEOF_API_GETSYSTEMWOW64DIRECTORYW CHAR NAMEOF_API_GETSYSTEMWOW64DIRECTORYW[] = { 'G', 'e', 't', 'S', 'y', 's', 't', 'e', 'm', 'W', 'o', 'w', '6', '4', 'D', 'i', 'r', 'e', 'c', 't', 'o', 'r', 'y', 'W', 0, };
...
/* "SetSystemPowerState" */
#define DECLARE_NAMEOF_API_SETSYSTEMPOWERSTATE CHAR NAMEOF_API_SETSYSTEMPOWERSTATE[] = { 'S', 'e', 't', 'S', 'y', 's', 't', 'e', 'm', 'P', 'o', 'w', 'e', 'r', 'S', 't', 'a', 't', 'e', 0, };
...
/* @brief
   ...
   @comment
    see SystemHalt
 */
typedef BOOL (__stdcall *SETSYSTEMPOWERSTATE)
(
    ___in BOOL fSuspend,
    ___in BOOL fForce
);
...
#define DECLARE_NAMEOF_API_GETSYSTEMPOWERSTATUS CHAR NAMEOF_API_GETSYSTEMPOWERSTATUS[] = { 'G', 'e', 't', 'S', 'y', 's', 't', 'e', 'm', 'P', 'o', 'w', 'e', 'r', 'S', 't', 'a', 't', 'u', 's', 0, };
 ...
 */
typedef BOOL (__stdcall* GETSYSTEMPOWERSTATUS)
(
    ___out LPSYSTEM_POWER_STATUS lpSystemPowerStatus
);
...
/* "CreateJobObjectA" */
#define DECLARE_NAMEOF_API_CREATEJOBOBJECTA CHAR NAMEOF_API_CREATEJOBOBJECTA[] = { 'C', 'r', 'e', 'a', 't', 'e', 'J', 'o', 'b', 'O', 'b', 'j', 'e', 'c', 't', 'A', 0, };
/* "CreateJobObjectW" */
#define DECLARE_NAMEOF_API_CREATEJOBOBJECTW CHAR NAMEOF_API_CREATEJOBOBJECTW[] = { 'C', 'r', 'e', 'a', 't', 'e', 'J', 'o', 'b', 'O', 'b', 'j', 'e', 'c', 't', 'W', 0, };

/* @brief
    Creates or opens a job object.
 */
typedef HANDLE (__stdcall *CREATEJOBOBJECTA)
(
    __in_opt LPSECURITY_ATTRIBUTES lpJobAttributes,
    __in_opt LPCSTR lpName
);
typedef HANDLE (__stdcall *CREATEJOBOBJECTW)
(
    __in_opt LPSECURITY_ATTRIBUTES lpJobAttributes,
...
#define DECLARE_NAMEOF_API_ASSIGNPROCESSTOJOBOBJECT CHAR NAMEOF_API_ASSIGNPROCESSTOJOBOBJECT[] = { 'A', 's', 's', 'i', 'g', 'n', 'P', 'r', 'o', 'c', 'e', 's', 's', 'T', 'o', 'J', 'o', 'b', 'O', 'b', 'j', 'e', 'c', 't', 0, };

/* @brief
    Assigns a process to an existing job object.
 */
typedef BOOL (__stdcall *ASSIGNPROCESSTOJOBOBJECT)
(
    ___in HANDLE hJob,
    ___in HANDLE hProcess
);
...
/* "TerminateJobObject" */
#define DECLARE_NAMEOF_API_TERMINATEJOBOBJECT CHAR NAMEOF_API_TERMINATEJOBOBJECT[] = { 'T', 'e', 'r', 'm', 'i', 'n', 'a', 't', 'e', 'J', 'o', 'b', 'O', 'b', 'j', 'e', 'c', 't', 0, };
 ...
 */
typedef BOOL (__stdcall *TERMINATEJOBOBJECT)
(
    ___in HANDLE hJob,
...
#define DECLARE_NAMEOF_API_PROCESSIDTOSESSIONID CHAR NAMEOF_API_PROCESSIDTOSESSIONID[] = { 'P', 'r', 'o', 'c', 'e', 's', 's', 'I', 'd', 'T', 'o', 'S', 'e', 's', 's', 'i', 'o', 'n', 'I', 'd', 0, };

/* @brief
    Retrieves the Remote Desktop Services session associated with a specified process.
 */
typedef BOOL (__stdcall *PROCESSIDTOSESSIONID)
(
    DWORD dwProcessId,
    DWORD *                 pSessionId
);
...
#define DECLARE_NAMEOF_API_WTSGETACTIVECONSOLESESSIONID CHAR NAMEOF_API_WTSGETACTIVECONSOLESESSIONID[] = { 'W', 'T', 'S', 'G', 'e', 't', 'A', 'c', 't', 'i', 'v', 'e', 'C', 'o', 'n', 's', 'o', 'l', 'e', 'S', 'e', 's', 's', 'i', 'o', 'n', 'I', 'd', 0, };
...
/* "IsWow64Process" */
#define DECLARE_NAMEOF_API_ISWOW64PROCESS CHAR NAMEOF_API_ISWOW64PROCESS[] = { 'I', 's', 'W', 'o', 'w', '6', '4', 'P', 'r', 'o', 'c', 'e', 's', 's', 0, };
...
#define DECLARE_NAMEOF_API_WOW64ENABLEWOW64FSREDIRECTION CHAR NAMEOF_API_WOW64ENABLEWOW64FSREDIRECTION[] = { 'W', 'o', 'w', '6', '4', 'E', 'n', 'a', 'b', 'l', 'e', 'W', 'o', 'w', '6', '4', 'F', 's', 'R', 'e', 'd', 'i', 'r', 'e', 'c', 't', 'i', 'o', 'n', 0, };
/* "Wow64DisableWow64FsRedirection" */
#define DECLARE_NAMEOF_API_WOW64DISABLEWOW64FSREDIRECTION CHAR NAMEOF_API_WOW64DISABLEWOW64FSREDIRECTION[] = { 'W', 'o', 'w', '6', '4', 'D', 'i', 's', 'a', 'b', 'l', 'e', 'W', 'o', 'w', '6', '4', 'F', 's', 'R', 'e', 'd', 'i', 'r', 'e', 'c', 't', 'i', 'o', 'n', 0, };
/* "Wow64RevertWow64FsRedirection" */
#define DECLARE_NAMEOF_API_WOW64REVERTWOW64FSREDIRECTION CHAR NAMEOF_API_WOW64REVERTWOW64FSREDIRECTION[] = { 'W', 'o', 'w', '6', '4', 'R', 'e', 'v', 'e', 'r', 't', 'W', 'o', 'w', '6', '4', 'F', 's', 'R', 'e', 'd', 'i', 'r', 'e', 'c', 't', 'i', 'o', 'n', 0, };
...
/* "CreateFiber" */
#define DECLARE_NAMEOF_API_CREATEFIBER CHAR NAMEOF_API_CREATEFIBER[] = { 'C', 'r', 'e', 'a', 't', 'e', 'F', 'i', 'b', 'e', 'r', 0, };
/* "DeleteFiber" */
#define DECLARE_NAMEOF_API_DELETEFIBER CHAR NAMEOF_API_DELETEFIBER[] = { 'D', 'e', 'l', 'e', 't', 'e', 'F', 'i', 'b', 'e', 'r', 0, };
/* "SwitchToFiber" */
#define DECLARE_NAMEOF_API_SWITCHTOFIBER CHAR NAMEOF_API_SWITCHTOFIBER[] = { 'S', 'w', 'i', 't', 'c', 'h', 'T', 'o', 'F', 'i', 'b', 'e', 'r', 0, };
/* "ConvertThreadToFiber" */
#define DECLARE_NAMEOF_API_CONVERTTHREADTOFIBER CHAR NAMEOF_API_CONVERTTHREADTOFIBER[] = { 'C', 'o', 'n', 'v', 'e', 'r', 't', 'T', 'h', 'r', 'e', 'a', 'd', 'T', 'o', 'F', 'i', 'b', 'e', 'r', 0, };
/* "ConvertFiberToThread" */
#define DECLARE_NAMEOF_API_CONVERTFIBERTOTHREAD CHAR NAMEOF_API_CONVERTFIBERTOTHREAD[] = { 'C', 'o', 'n', 'v', 'e', 'r', 't', 'F', 'i', 'b', 'e', 'r', 'T', 'o', 'T', 'h', 'r', 'e', 'a', 'd', 0, };
 ...
 */
typedef LPVOID (__stdcall *CREATEFIBER)
(
    ___in SIZE_T dwStackSize,
    ___in LPFIBER_START_ROUTINE lpStartAddress,
...
/* "SwitchToThread" */
#define DECLARE_NAMEOF_API_SWITCHTOTHREAD CHAR NAMEOF_API_SWITCHTOTHREAD[] = { 'S', 'w', 'i', 't', 'c', 'h', 'T', 'o', 'T', 'h', 'r', 'e', 'a', 'd', 0, };
/* @brief
...
/* "DuplicateHandle" */
#define DECLARE_NAMEOF_API_DUPLICATEHANDLE CHAR NAMEOF_API_DUPLICATEHANDLE[] = { 'D', 'u', 'p', 'l', 'i', 'c', 'a', 't', 'e', 'H', 'a', 'n', 'd', 'l', 'e', 0, };
...
(
    ___in HANDLE hSourceProcessHandle,
    ___in HANDLE hSourceHandle,
    ___in HANDLE hTargetProcessHandle,
    __deref_out LPHANDLE lpTargetHandle,
    ___in DWORD dwDesiredAccess,
    ___in BOOL bInheritHandle,
    ___in DWORD dwOptions
);

/* "GetSystemTimes" */
#define DECLARE_NAMEOF_API_GETSYSTEMTIMES CHAR NAMEOF_API_GETSYSTEMTIMES[] = { 'G', 'e', 't', 'S', 'y', 's', 't', 'e', 'm', 'T', 'i', 'm', 'e', 's', 0, };
/* "GetProcessTimes" */
#define DECLARE_NAMEOF_API_GETPROCESSTIMES CHAR NAMEOF_API_GETPROCESSTIMES[] = { 'G', 'e', 't', 'P', 'r', 'o', 'c', 'e', 's', 's', 'T', 'i', 'm', 'e', 's', 0, };

/* @brief
    Retrieves system timing information.
    On a multiprocessor system, the values returned are the sum of the designated times across all processors.
 */
typedef BOOL (__stdcall* GETSYSTEMTIMES)
(
 ...
 */
typedef BOOL (__stdcall *GETPROCESSTIMES)
(
    ___in HANDLE hProcess,
    ___out LPFILETIME lpCreationTime,
    ___out LPFILETIME lpExitTime,
    ___out LPFILETIME lpKernelTime,
    ___out LPFILETIME lpUserTime
);

/* "GlobalMemoryStatusEx" */
#define DECLARE_NAMEOF_API_GLOBALMEMORYSTATUSEX CHAR NAMEOF_API_GLOBALMEMORYSTATUSEX[] = { 'G', 'l', 'o', 'b', 'a', 'l', 'M', 'e', 'm', 'o', 'r', 'y', 'S', 't', 'a', 't', 'u', 's', 'E', 'x', 0, };
...
#define DECLARE_NAMEOF_API_READDIRECTORYCHANGESW CHAR NAMEOF_API_READDIRECTORYCHANGESW[] = { 'R', 'e', 'a', 'd', 'D', 'i', 'r', 'e', 'c', 't', 'o', 'r', 'y', 'C', 'h', 'a', 'n', 'g', 'e', 's', 'W', 0, };
 ...
 */
typedef BOOL (__stdcall *READDIRECTORYCHANGESW)(
    ___in HANDLE hDirectory,
    ___out LPVOID lpBuffer,
    ___in DWORD nBufferLength,
    ___in BOOL bWatchSubtree,
    ___in DWORD dwNotifyFilter,
...
#define DECLARE_NAMEOF_API_GETVOLUMENAMEFORVOLUMEMOUNTPOINTA CHAR NAMEOF_API_GETVOLUMENAMEFORVOLUMEMOUNTPOINTA[] = { 'G', 'e', 't', 'V', 'o', 'l', 'u', 'm', 'e', 'N', 'a', 'm', 'e', 'F', 'o', 'r', 'V', 'o', 'l', 'u', 'm', 'e', 'M', 'o', 'u', 'n', 't', 'P', 'o', 'i', 'n', 't', 'A', 0, };
/* "GetVolumeNameForVolumeMountPointW" */
#define DECLARE_NAMEOF_API_GETVOLUMENAMEFORVOLUMEMOUNTPOINTW CHAR NAMEOF_API_GETVOLUMENAMEFORVOLUMEMOUNTPOINTW[] = { 'G', 'e', 't', 'V', 'o', 'l', 'u', 'm', 'e', 'N', 'a', 'm', 'e', 'F', 'o', 'r', 'V', 'o', 'l', 'u', 'm', 'e', 'M', 'o', 'u', 'n', 't', 'P', 'o', 'i', 'n', 't', 'W', 0, };
 ...
 */
typedef BOOL (__stdcall *GETVOLUMENAMEFORVOLUMEMOUNTPOINTA)(
    ___in LPCSTR lpszVolumeMountPoint,
    __out_ecount (cchBufferLength) LPSTR lpszVolumeName,
    ___in DWORD cchBufferLength
    );
/* @brief
 */
typedef BOOL (__stdcall *GETVOLUMENAMEFORVOLUMEMOUNTPOINTW)(
    ___in LPCWSTR lpszVolumeMountPoint,
...
/* "QueryDosDeviceA" */
#define DECLARE_NAMEOF_API_QUERYDOSDEVICEA CHAR NAMEOF_API_QUERYDOSDEVICEA[] = { 'Q', 'u', 'e', 'r', 'y', 'D', 'o', 's', 'D', 'e', 'v', 'i', 'c', 'e', 'A', 0, };
/* "QueryDosDeviceW" */
#define DECLARE_NAMEOF_API_QUERYDOSDEVICEW CHAR NAMEOF_API_QUERYDOSDEVICEW[] = { 'Q', 'u', 'e', 'r', 'y', 'D', 'o', 's', 'D', 'e', 'v', 'i', 'c', 'e', 'W', 0, };
 ...
 */
typedef DWORD (WINAPI *QUERYDOSDEVICEA)(
    IN OUT LPCSTR lpDeviceName,
    OUT LPSTR lpTargetPath,
    IN DWORD ucchMax
    );

typedef DWORD (WINAPI *QUERYDOSDEVICEW)(
    IN OUT LPCWSTR lpDeviceName,
    OUT LPWSTR lpTargetPath,
    IN DWORD ucchMax
    );

/* "GetSystemFirmwareTable" */
#define DECLARE_NAMEOF_API_GETSYSTEMFIRMWARETABLE CHAR NAMEOF_API_GETSYSTEMFIRMWARETABLE[] = { 'G', 'e', 't', 'S', 'y', 's', 't', 'e', 'm', 'F', 'i', 'r', 'm', 'w', 'a', 'r', 'e', 'T', 'a', 'b', 'l', 'e', 0, };

/* @brief
    Retrieves the specified firmware table from the firmware table provider.
 */
typedef UINT (__stdcall *GETSYSTEMFIRMWARETABLE)(
    ___in DWORD FirmwareTableProviderSignature,
    ___in DWORD FirmwareTableID,
    ___out PVOID pFirmwareTableBuffer,
...
#define DECLARE_NAMEOF_API_QUERYFULLPROCESSIMAGENAMEA CHAR NAMEOF_API_QUERYFULLPROCESSIMAGENAMEA[] = { 'Q', 'u', 'e', 'r', 'y', 'F', 'u', 'l', 'l', 'P', 'r', 'o', 'c', 'e', 's', 's', 'I', 'm', 'a', 'g', 'e', 'N', 'a', 'm', 'e', 'A', 0, };
/* "QueryFullProcessImageNameW" */
#define DECLARE_NAMEOF_API_QUERYFULLPROCESSIMAGENAMEW CHAR NAMEOF_API_QUERYFULLPROCESSIMAGENAMEW[] = { 'Q', 'u', 'e', 'r', 'y', 'F', 'u', 'l', 'l', 'P', 'r', 'o', 'c', 'e', 's', 's', 'I', 'm', 'a', 'g', 'e', 'N', 'a', 'm', 'e', 'W', 0, };

/* @brief
    Retrieves the full name of the executable image for the specified process.
 */
typedef BOOL (__stdcall *QUERYFULLPROCESSIMAGENAMEA)(
    ___in HANDLE hProcess,
    ___in DWORD dwFlags,
    ___out LPSTR lpExeName,
    __inout PDWORD lpdwSize
    );

typedef BOOL (__stdcall *QUERYFULLPROCESSIMAGENAMEW)(
    ___in HANDLE hProcess,
    ___in DWORD dwFlags,
    ___out LPWSTR lpExeName,
    __inout PDWORD lpdwSize
    );

typedef VOID (__stdcall* RTLCAPTURECONTEXT)(OUT PCONTEXT ContextRecord);
/* "RtlCaptureContext" */
#define DECLARE_NAMEOF_API_RTLCAPTURECONTEXT CHAR NAMEOF_API_RTLCAPTURECONTEXT[] = { 'R', 't', 'l', 'C', 'a', 'p', 't', 'u', 'r', 'e', 'C', 'o', 'n', 't', 'e', 'x', 't', 0, };
...
/* "GetLocaleInfoEx" */
#define DECLARE_NAMEOF_API_GETLOCALEINFOEX CHAR NAMEOF_API_GETLOCALEINFOEX[] = { 'G', 'e', 't', 'L', 'o', 'c', 'a', 'l', 'e', 'I', 'n', 'f', 'o', 'E', 'x', 0, };
