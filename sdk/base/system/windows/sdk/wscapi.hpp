...
(
    ___in LPVOID Reserved,
    ___out PHANDLE phCallbackRegistration,
    ___in LPTHREAD_START_ROUTINE lpCallbackAddress,
...
(
    ___in HANDLE hRegistrationHandle
);
...
(
    ___in DWORD Providers,
    ___out /*PWSC_SECURITY_PROVIDER_HEALTH*/ INT* pHealth
);
