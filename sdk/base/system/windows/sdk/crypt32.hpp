...
typedef BOOL (WINAPI *CRYPTQUERYOBJECT)(
    ___in DWORD dwObjectType,
    ___in const void*   pvObject,
    ___in DWORD dwExpectedContentTypeFlags,
    ___in DWORD dwExpectedFormatTypeFlags,
    ___in DWORD dwFlags,
    ___out DWORD*        pdwMsgAndCertEncodingType,
    ___out DWORD*        pdwContentType,
    ___out DWORD*        pdwFormatType,
    ___out HCERTSTORE*   phCertStore,
    ___out HCRYPTMSG*    phMsg,
...
typedef BOOL (WINAPI *CERTCREATECERTIFICATECHAINENGINE)(
    ___in PCERT_CHAIN_ENGINE_CONFIG pConfig,
    ___out HCERTCHAINENGINE*         phChainEngine
    );
...
typedef BOOL (WINAPI *CRYPTMSGGETPARAM)(
    ___in HCRYPTMSG hCryptMsg,
    ___in DWORD dwParamType,
    ___in DWORD dwIndex,
    ___out void*     pvData,
...
typedef PCCERT_CONTEXT (WINAPI *CERTFINDCERTIFICATEINSTORE)(
    ___in HCERTSTORE hCertStore,
    ___in DWORD dwCertEncodingType,
    ___in DWORD dwFindFlags,
    ___in DWORD dwFindType,
    ___in const void*           pvFindPara,
    ___in PCCERT_CONTEXT pPrevCertContext
    );
...
typedef BOOL (WINAPI *CERTGETCERTIFICATECHAIN)(
    ...
    ___in PCCERT_CONTEXT pCertContext,
    __in_opt LPFILETIME pTime,
    ___in HCERTSTORE hAdditionalStore,
    ___in PCERT_CHAIN_PARA pChainPara,
    ___in DWORD dwFlags,
    ___in LPVOID pvReserved,
...
typedef void (WINAPI *CERTFREECERTIFICATECHAINENGINE)(
    ___in HCERTCHAINENGINE hChainEngine
    );
...
typedef DWORD (WINAPI *CERTGETNAMESTRING)(
    ...
    ___in DWORD dwType,
    ___in DWORD dwFlags,
    ___in void*                 pvTypePara,
    ___out LPTSTR pszNameString,
