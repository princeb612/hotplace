...
typedef BOOL (__stdcall *LOGONUSER)(
    ___in LPTSTR lpszUsername,
    __in_opt LPTSTR lpszDomain,
    ___in LPTSTR lpszPassword,
    ___in DWORD dwLogonType,
    ___in DWORD dwLogonProvider,
...
typedef BOOL (WINAPI *CREATEPROCESSWITHLOGONW)(
    ___in LPCWSTR lpUsername,
    __in_opt LPCWSTR lpDomain,
    ___in LPCWSTR lpPassword,
    ___in DWORD dwLogonFlags,
    __in_opt LPCWSTR lpApplicationName,
    __inout_opt LPWSTR lpCommandLine,
    ___in DWORD dwCreationFlags,
    __in_opt LPVOID lpEnvironment,
    __in_opt LPCWSTR lpCurrentDirectory,
    ___in LPSTARTUPINFOW lpStartupInfo,
...
typedef BOOL (__stdcall* OPENTHREADTOKEN)(
    ___in HANDLE ThreadHandle,
    ___in DWORD DesiredAccess,
    ___in BOOL OpenAsSelf,
    ___out PHANDLE TokenHandle
    );
...
typedef BOOL (__stdcall* INITIALIZEACL)(
    ___out PACL pAcl,
    ___in DWORD nAclLength,
    ___in DWORD dwAclRevision
    );
...
typedef BOOL (__stdcall* ADDACCESSALLOWEDACE)(
    __inout PACL pAcl,
    ___in DWORD dwAceRevision,
    ___in DWORD AccessMask,
    ___in PSID pSid
    );
...
typedef BOOL (__stdcall* CREATEWELLKNOWNSID)(
    ___in WELL_KNOWN_SID_TYPE WellKnownSidType,
...
typedef BOOL (__stdcall* INITIALIZESECURITYDESCRIPTOR)(
    ___out PSECURITY_DESCRIPTOR pSecurityDescriptor,
    ___in DWORD dwRevision
    );
...
typedef BOOL (__stdcall *CHECKTOKENMEMBERSHIP)(
    ...
    ___in PSID SidToCheck,
    ___out PBOOL IsMember
    );
...
typedef BOOL (WINAPI *CHANGESERVICECONFIG)(
    ___in SC_HANDLE hService,
    ___in DWORD dwServiceType,
    ___in DWORD dwStartType,
    ___in DWORD dwErrorControl,
...
typedef BOOL (WINAPI *CONTROLSERVICE)(
    ___in SC_HANDLE hService,
    ___in DWORD dwControl,
    ___out LPSERVICE_STATUS lpServiceStatus
    );
...
typedef SC_HANDLE (WINAPI *CREATESERVICE)(
    ___in SC_HANDLE hSCManager,
    ___in LPCTSTR lpServiceName,
    ___in LPCTSTR lpDisplayName,
    ___in DWORD dwDesiredAccess,
    ___in DWORD dwServiceType,
    ___in DWORD dwStartType,
    ___in DWORD dwErrorControl,
    ___in LPCTSTR lpBinaryPathName,
    ___in LPCTSTR lpLoadOrderGroup,
    ___out LPDWORD lpdwTagId,
    ___in LPCTSTR lpDependencies,
    ___in LPCTSTR lpServiceStartName,
...
typedef BOOL (WINAPI *ENUMDEPENDENTSERVICES)(
    ___in SC_HANDLE hService,
    ___in DWORD dwServiceState,
    ___out LPENUM_SERVICE_STATUS lpServices,
    ___in DWORD cbBufSize,
    ___out LPDWORD pcbBytesNeeded,
    ___out LPDWORD lpServicesReturned
    );
...
typedef SC_HANDLE (WINAPI *OPENSCMANAGER)(
    ___in LPCTSTR lpMachineName,
    ___in LPCTSTR lpDatabaseName,
    ___in DWORD dwDesiredAccess
    );
...
typedef BOOL (WINAPI* QUERYSERVICECONFIG)(
    ___in SC_HANDLE hService,
    ___out LPQUERY_SERVICE_CONFIG lpServiceConfig,
    ___in DWORD cbBufSize,
    ___out LPDWORD pcbBytesNeeded
    );
...
typedef BOOL (WINAPI *STARTSERVICE)(
    ___in SC_HANDLE hService,
    ___in DWORD dwNumServiceArgs,
    ___in LPCTSTR* lpServiceArgVectors
    );
...
typedef SERVICE_STATUS_HANDLE (WINAPI *REGISTERSERVICECTRLHANDLER)(
    ___in LPCTSTR lpServiceName,
    ___in LPHANDLER_FUNCTION lpHandlerProc
    );
...
typedef SERVICE_STATUS_HANDLE (WINAPI *REGISTERSERVICECTRLHANDLEREX)(
    ___in LPCTSTR lpServiceName,
    ___in LPHANDLER_FUNCTION_EX lpHandlerProc,
...
typedef BOOL (WINAPI *SETSERVICESTATUS)(
    ___in SERVICE_STATUS_HANDLE hServiceStatus,
    ___in LPSERVICE_STATUS lpServiceStatus
    );
...
typedef BOOL (WINAPI *STARTSERVICECTRLDISPATCHER)(
    ___in const SERVICE_TABLE_ENTRY* lpServiceTable
    );
...
typedef BOOL (__stdcall *INITIATESYSTEMSHUTDOWN)(
    ___in LPTSTR lpMachineName,
    ___in LPTSTR lpMessage,
    ___in DWORD dwTimeout,
    ___in BOOL bForceAppsClosed,
...
typedef BOOL (WINAPI *CRYPTACQUIRECONTEXT)(
    ___out HCRYPTPROV* phProv,
    ___in LPCTSTR pszContainer,
    ___in LPCTSTR pszProvider,
    ___in DWORD dwProvType,
    ___in DWORD dwFlags
    );
/* @brief
...
typedef BOOL (WINAPI *CRYPTCREATEHASH)(
    ___in HCRYPTPROV hProv,
    ___in ALG_ID Algid,
    ___in HCRYPTKEY hKey,
    ___in DWORD dwFlags,
    ___out HCRYPTHASH* phHash
    );
/* @brief
...
typedef BOOL (WINAPI *CRYPTHASHDATA)(
    ___in HCRYPTHASH hHash,
    ___in BYTE* pbData,
    ___in DWORD dwDataLen,
    ___in DWORD dwFlags
    );
/* @brief
...
typedef BOOL (WINAPI *CONVERTSIDTOSTRINGSIDA)(
    ___in PSID Sid,
    ___out LPSTR*  StringSid
    );

typedef BOOL (WINAPI *CONVERTSIDTOSTRINGSIDW)(
    ___in PSID Sid,
    ___out LPWSTR* StringSid
    );
