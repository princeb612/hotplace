...
#ifndef __HOTPLACE_SDK_IO_ASN1_BASIC_ASN1ENUM__
#define __HOTPLACE_SDK_IO_ASN1_BASIC_ASN1ENUM__
...
class asn1_enum : public asn1_type {
   public:
    ...
    asn1_enum(const std::initializer_list<std::pair<std::string, asn1_native_int_t>>& items);
    asn1_enum(const std::string& name, const std::initializer_list<std::pair<std::string, asn1_native_int_t>>& items);
    virtual ~asn1_enum();
