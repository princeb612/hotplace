 ...
 *                              }));
 */
class asn1_constraint_intersection : public asn1_constraint {
   public:
    asn1_constraint_intersection(asn1_constraint* lhs, asn1_constraint* rhs);
    virtual ~asn1_constraint_intersection();

    asn1_constraint_intersection* clone();
   ...
   protected:
    asn1_constraint_intersection(const asn1_constraint_intersection& other);
