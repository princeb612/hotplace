...
wide_string::wide_string (size_t allocsize, uint32 flags)
{
    _bio.open (&_handle, allocsize, sizeof (wchar_t), flags | bufferio_context_flag_t::memzero_free);
}
...
return_t wide_string::write (void* data, size_t size)
{
...
const wchar_t* wide_string::c_str ()
{
...
size_t wide_string::find (wchar_t* data)
{
    return _bio.wfind_first_of (_handle, data);
}

return_t wide_string::replace (const wchar_t* from, const wchar_t* to, size_t begin, int flag)
{
    return _bio.wreplace (_handle, from, to, begin, flag);
}
...
return_t wide_string::cut (size_t begin, size_t len)
{
    return _bio.cut (_handle, begin * sizeof (wchar_t), len * sizeof (wchar_t));
}
...
size_t wide_string::find_first_of (const wchar_t* find, size_t offset)
{
    return _bio.wfind_first_of (_handle, find, offset);
}

size_t wide_string::find_not_first_of (const wchar_t* find, size_t offset)
{
    return _bio.wfind_not_first_of (_handle, find, offset);
}

size_t wide_string::find_last_of (const wchar_t* find)
{
    return _bio.wfind_last_of (_handle, find);
}

size_t wide_string::find_not_last_of (const wchar_t* find)
{
    return _bio.wfind_not_last_of (_handle, find);
}
...
int wide_string::compare (wide_string& lhs, wide_string& rhs)
{
    return wcscmp (lhs.c_str (), rhs.c_str ());
}

bool wide_string::operator < (wide_string& buf)
{
    return 0 < wcscmp ((*this).c_str (), buf.c_str ());
}
