...
obfuscate_string::obfuscate_string (std::string& source) : _flags (0)
{
    assign (source.c_str (), source.size ());
}

obfuscate_string::obfuscate_string (ansi_string& source) : _flags (0)
{
    assign (source.c_str (), source.size ());
}
...
size_t obfuscate_string::size ()
{
    return _contents.size ();
}

bool obfuscate_string::empty ()
{
    return (0 == _contents.size ()) ? true : false;
}
...
bool obfuscate_string::operator == (obfuscate_string& o)
{
    return true == compare (o);
}
