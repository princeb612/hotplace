...
static ascii_token_table_t _ascii_token_table[256] = {
    ...
    {0x23, "#", token_unknown},    {0x24, "$", token_unknown},   {0x25, "%", token_unknown},   {0x26, "&", token_amp},        {0x27, "'", token_squote},
    ...
    {0x3C, "<", token_lesser},     {0x3D, "=", token_equal},     {0x3E, ">", token_greater},   {0x3F, "?", token_unknown},    {0x40, "@", token_at},
