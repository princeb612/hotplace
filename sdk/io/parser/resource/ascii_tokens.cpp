...
static ascii_token_table_t _ascii_token_table[256] = {
    ...
    {0x1E, "RS", token_unknown},   {0x1F, "US", token_unknown},  {0x20, "SP", token_space},    {0x21, "!", token_exclamation}, {0x22, "\"", token_dquote},
    {0x23, "#", token_sharp},      {0x24, "$", token_dollar},    {0x25, "%", token_percent},   {0x26, "&", token_amp},         {0x27, "'", token_squote},
    {0x28, "(", token_lparen},     {0x29, ")", token_rparen},    {0x2A, "*", token_asterisk},  {0x2B, "+", token_plus},        {0x2C, ",", token_comma},
    {0x2D, "-", token_dash},       {0x2E, ".", token_dot},       {0x2F, "/", token_slash},     {0x30, "0", token_number},      {0x31, "1", token_number},
    ...
    {0x3C, "<", token_lesser},     {0x3D, "=", token_equal},     {0x3E, ">", token_greater},   {0x3F, "?", token_question},    {0x40, "@", token_at},
    ...
    {0x5A, "Z", token_alpha},      {0x5B, "[", token_lbracket},  {0x5C, "\\", token_bslash},   {0x5D, "]", token_rbracket},    {0x5E, "^", token_caret},
    {0x5F, "_", token_underline},  {0x60, "`", token_backtick},  {0x61, "a", token_alpha},     {0x62, "b", token_alpha},       {0x63, "c", token_alpha},
    ...
    {0x78, "x", token_alpha},      {0x79, "y", token_alpha},     {0x7A, "z", token_alpha},     {0x7B, "{", token_lbrace},      {0x7C, "|", token_pipe},
    {0x7D, "}", token_rbrace},     {0x7E, "~", token_tilde},     {0x7F, "DEL", token_unknown}, {0x80, "€", token_unknown},     {0x81, "", token_unknown},
