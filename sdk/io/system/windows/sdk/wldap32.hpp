...
#ifndef __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_WLDAP32__
#define __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_WLDAP32__
...
typedef LDAP* (*LDAP_INITW)(__in const PWCHAR HostName, ULONG PortNumber);
...
typedef ULONG (*LDAP_SEARCHW)(LDAP* ld, __in const PWCHAR base, ULONG scope, __in const PWCHAR filter, __in PWCHAR attrs[], ULONG attrsonly);
/* ldap_searchA */
#define DECLARE_NAMEOF_API_LDAP_SEARCHA CHAR NAMEOF_API_LDAP_SEARCHA[] = { 'l', 'd', 'a', 'p', '_', 's', 'e', 'a', 'r', 'c', 'h', 'A', 0, };
typedef ULONG (*LDAP_SEARCHA)(LDAP* ld, __in const PCHAR base, ULONG scope, __in const PCHAR filter, __in PCHAR attrs[], ULONG attrsonly);

/* ldap_search_sW */
#define DECLARE_NAMEOF_API_LDAP_SEARCH_SW CHAR NAMEOF_API_LDAP_SEARCH_SW[] = { 'l', 'd', 'a', 'p', '_', 's', 'e', 'a', 'r', 'c', 'h', '_', 's', 'W', 0, };
typedef ULONG (*LDAP_SEARCH_SW)(LDAP* ld, __in const PWCHAR base, ULONG scope, __in const PWCHAR filter, __in PWCHAR attrs[], ULONG attrsonly, LDAPMessage **res);
/* ldap_search_sA */
...
typedef ULONG (*LDAP_SEARCH_STW)(LDAP* ld, __in const PWCHAR base, ULONG scope, __in const PWCHAR filter, __in PWCHAR attrs[], ULONG attrsonly, struct l_timeval *timeout, LDAPMessage **res);
/* ldap_search_stA */
...
typedef ULONG (*LDAP_SEARCH_EXTW)(LDAP* ld, __in const PWCHAR base, ULONG scope, __in const PWCHAR filter, __in PWCHAR attrs[], ULONG attrsonly, PLDAPControlW *ServerControls, PLDAPControlW *ClientControls, ULONG TimeLimit, ULONG SizeLimit, ULONG *MessageNumber);

/* ldap_search_extA */
#define DECLARE_NAMEOF_API_LDAP_SEARCH_EXTA CHAR NAMEOF_API_LDAP_SEARCH_EXTA[] = { 'l', 'd', 'a', 'p', '_', 's', 'e', 'a', 'r', 'c', 'h', '_', 'e', 'x', 't', 'A', 0, };
typedef ULONG (*LDAP_SEARCH_EXTA)(LDAP* ld, __in const PCHAR base, ULONG scope, __in const PCHAR filter, __in PCHAR attrs[], ULONG attrsonly, PLDAPControlA *ServerControls, PLDAPControlA *ClientControls, ULONG TimeLimit, ULONG SizeLimit, ULONG *MessageNumber);
...
typedef PWCHAR* (*LDAP_GET_VALUESW)(LDAP* ld, LDAPMessage *entry, __in const PWCHAR attr);

/* ldap_get_valuesA */
#define DECLARE_NAMEOF_API_LDAP_GET_VALUESA CHAR NAMEOF_API_LDAP_GET_VALUESA[] = { 'l', 'd', 'a', 'p', '_', 'g', 'e', 't', '_', 'v', 'a', 'l', 'u', 'e', 's', 'A', 0, };
typedef PCHAR * (*LDAP_GET_VALUESA)(LDAP *ld, LDAPMessage *entry, __in const PCHAR attr);
...
typedef VOID (*LDAP_MEMFREEW)( __in PWCHAR Block );
/* ldap_memfreeA */
