...
#ifndef __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_WS2_32__
#define __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_WS2_32__
...
#define DECLARE_NAMEOF_API_WSALOOKUPSERVICEBEGINA CHAR NAMEOF_API_WSALOOKUPSERVICEBEGINA[] = { 'W', 'S', 'A', 'L', 'o', 'o', 'k', 'u', 'p', 'S', 'e', 'r', 'v', 'i', 'c', 'e', 'B', 'e', 'g', 'i', 'n', 'A', 0, };
/* "WSALookupServiceBeginW" */
#define DECLARE_NAMEOF_API_WSALOOKUPSERVICEBEGINW CHAR NAMEOF_API_WSALOOKUPSERVICEBEGINW[] = { 'W', 'S', 'A', 'L', 'o', 'o', 'k', 'u', 'p', 'S', 'e', 'r', 'v', 'i', 'c', 'e', 'B', 'e', 'g', 'i', 'n', 'W', 0, };
/* "WSALookupServiceNextA" */
#define DECLARE_NAMEOF_API_WSALOOKUPSERVICENEXTA CHAR NAMEOF_API_WSALOOKUPSERVICENEXTA[] = { 'W', 'S', 'A', 'L', 'o', 'o', 'k', 'u', 'p', 'S', 'e', 'r', 'v', 'i', 'c', 'e', 'N', 'e', 'x', 't', 'A', 0, };
/* "WSALookupServiceNextW" */
#define DECLARE_NAMEOF_API_WSALOOKUPSERVICENEXTW CHAR NAMEOF_API_WSALOOKUPSERVICENEXTW[] = { 'W', 'S', 'A', 'L', 'o', 'o', 'k', 'u', 'p', 'S', 'e', 'r', 'v', 'i', 'c', 'e', 'N', 'e', 'x', 't', 'W', 0, };
/* "WSALookupServiceEnd" */
#define DECLARE_NAMEOF_API_WSALOOKUPSERVICEEND CHAR NAMEOF_API_WSALOOKUPSERVICEEND[] = { 'W', 'S', 'A', 'L', 'o', 'o', 'k', 'u', 'p', 'S', 'e', 'r', 'v', 'i', 'c', 'e', 'E', 'n', 'd', 0, };
 ...
 */
typedef INT (WINAPI *WSALOOKUPSERVICEBEGINA)
(
...
typedef INT (WINAPI *WSALOOKUPSERVICEBEGINW)
(
...
/* @brief
    ...
    The provider will pass back a WSAQUERYSET structure in the lpqsResults buffer.
 ...
 */
typedef INT (WINAPI *WSALOOKUPSERVICENEXTA)
(
    HANDLE hLookup,
    DWORD dwControlFlags,
...
typedef INT (WINAPI *WSALOOKUPSERVICENEXTW)
(
    HANDLE hLookup,
    DWORD dwControlFlags,
    LPDWORD lpdwBufferLength,
 ...
 */
typedef INT (WINAPI *WSALOOKUPSERVICEEND)
(
    HANDLE hLookup
);
...
/* "WSANSPIoctl" */
#define DECLARE_NAMEOF_API_WSANSPIOCTL CHAR NAMEOF_API_WSANSPIOCTL[] = { 'W', 'S', 'A', 'N', 'S', 'P', 'I', 'o', 'c', 't', 'l', 0, };

/* @brief
    The Windows Sockets WSANSPIoctl function enables developers to make I/O control calls to a registered namespace.
 */
typedef int (WINAPI *WSANSPIOCTL)
(
    HANDLE hLookup,
    DWORD dwControlCode,
    LPVOID lpvInBuffer,
