...
#ifndef __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_SHELL32__
#define __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_SHELL32__
...
/* "SHGetFolderPathA" */
#define DECLARE_NAMEOF_API_SHGETFOLDERPATHA CHAR NAMEOF_API_SHGETFOLDERPATHA[] = { 'S', 'H', 'G', 'e', 't', 'F', 'o', 'l', 'd', 'e', 'r', 'P', 'a', 't', 'h', 'A', 0, };
/* "SHGetFolderPathW" */
#define DECLARE_NAMEOF_API_SHGETFOLDERPATHW CHAR NAMEOF_API_SHGETFOLDERPATHW[] = { 'S', 'H', 'G', 'e', 't', 'F', 'o', 'l', 'd', 'e', 'r', 'P', 'a', 't', 'h', 'W', 0, };
 ...
 */
typedef HRESULT (__stdcall * SHGETFOLDERPATHA)(
    HWND hwndOwner,
    int nFolder,
    HANDLE hToken,
    DWORD dwFlags,
...
typedef HRESULT (__stdcall * SHGETFOLDERPATHW)(
    HWND hwndOwner,
    int nFolder,
    HANDLE hToken,
    DWORD dwFlags,
...
/* ShellExecuteExA */
#define DECLARE_NAMEOF_API_SHELLEXECUTEEXA CHAR NAMEOF_API_SHELLEXECUTEEXA[] = { 'S', 'h', 'e', 'l', 'l', 'E', 'x', 'e', 'c', 'u', 't', 'e', 'E', 'x', 'A', 0, };
/* ShellExecuteExW */
#define DECLARE_NAMEOF_API_SHELLEXECUTEEXW CHAR NAMEOF_API_SHELLEXECUTEEXW[] = { 'S', 'h', 'e', 'l', 'l', 'E', 'x', 'e', 'c', 'u', 't', 'e', 'E', 'x', 'W', 0, };
