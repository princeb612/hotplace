...
#ifndef __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_SHLWAPI__
#define __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_SHLWAPI__
...
typedef HRESULT (__stdcall* QISEARCH)(__inout void* that, __in LPCQITAB pqit, __in REFIID riid, __deref_out void **ppv);
