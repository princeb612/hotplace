...
#ifndef __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_WININET__
#define __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_WININET__
...
typedef HANDLE (__stdcall* FINDFIRSTURLCACHEENTRYA)(
    __in LPCSTR lpszUrlSearchPattern,
    __out LPINTERNET_CACHE_ENTRY_INFOA_ lpFirstCacheEntryInfo,
    __inout LPDWORD lpcbCacheEntryInfo
    );

typedef HANDLE (__stdcall* FINDFIRSTURLCACHEENTRYW)(
    __in LPCWSTR lpszUrlSearchPattern,
    __out LPINTERNET_CACHE_ENTRY_INFOW_ lpFirstCacheEntryInfo,
    __inout LPDWORD lpcbCacheEntryInfo
    );
...
typedef BOOL (__stdcall* FINDNEXTURLCACHEENTRYA)(
    ...
    __out LPINTERNET_CACHE_ENTRY_INFOA_ lpNextCacheEntryInfo,
    __inout LPDWORD lpcbCacheEntryInfo
    );

typedef BOOL (__stdcall* FINDNEXTURLCACHEENTRYW)(
    __in HANDLE hEnumHandle,
    __out LPINTERNET_CACHE_ENTRY_INFOW_ lpNextCacheEntryInfo,
    __inout LPDWORD lpcbCacheEntryInfo
    );
