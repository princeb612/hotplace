...
#ifndef __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_KERNEL32__
#define __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_KERNEL32__
 ...
 */
typedef VOID (__stdcall *DELETEFIBER)(__in LPVOID lpFiber);
/* @brief
    Schedules a fiber. The function must be called on a fiber.
 */
typedef VOID (__stdcall *SWITCHTOFIBER)(__in LPVOID lpFiber);
/* @brief
...
typedef int (__stdcall* GETLOCALEINFOEX)(__in_opt LPCWSTR lpLocaleName, __in LCTYPE LCType, __out_opt LPWSTR lpLCData, __in int cchData);
/* "GetLocaleInfoEx" */
