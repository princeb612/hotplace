...
#ifndef __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_MSI__
#define __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_MSI__

#undef  NAMEOF_API_MSIGETFILEVERSION

/* "MsiGetFileVersionA" */
#define DECLARE_NAMEOF_API_MSIGETFILEVERSIONA CHAR NAMEOF_API_MSIGETFILEVERSIONA[] = { 'M', 's', 'i', 'G', 'e', 't', 'F', 'i', 'l', 'e', 'V', 'e', 'r', 's', 'i', 'o', 'n', 'A', 0, };
/* "MsiGetFileVersionW" */
#define DECLARE_NAMEOF_API_MSIGETFILEVERSIONW CHAR NAMEOF_API_MSIGETFILEVERSIONW[] = { 'M', 's', 'i', 'G', 'e', 't', 'F', 'i', 'l', 'e', 'V', 'e', 'r', 's', 'i', 'o', 'n', 'W', 0, };
 ...
 */
typedef UINT (WINAPI * MSIGETFILEVERSION)
(
    LPCTSTR szFilePath,
    LPTSTR lpVersionBuf,
