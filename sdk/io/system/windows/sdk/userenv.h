...
#ifndef __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_USERENV__
#define __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_USERENV__

/* "CreateEnvironmentBlock" */
#define DECLARE_NAMEOF_API_CREATEENVIRONMENTBLOCK CHAR NAMEOF_API_CREATEENVIRONMENTBLOCK[] = { 'C', 'r', 'e', 'a', 't', 'e', 'E', 'n', 'v', 'i', 'r', 'o', 'n', 'm', 'e', 'n', 't', 'B', 'l', 'o', 'c', 'k', 0, };
...
/* @brief
   ...
   @comment
    NT4+
 */
typedef BOOL (__stdcall *CREATEENVIRONMENTBLOCK)(
...
#define DECLARE_NAMEOF_API_DESTROYENVIRONMENTBLOCK CHAR NAMEOF_API_DESTROYENVIRONMENTBLOCK[] = { 'D', 'e', 's', 't', 'r', 'o', 'y', 'E', 'n', 'v', 'i', 'r', 'o', 'n', 'm', 'e', 'n', 't', 'B', 'l', 'o', 'c', 'k', 0, };
...
/* @brief
   ...
   @comment
    NT4+
 */
typedef BOOL (__stdcall *GETUSERPROFILEDIRECTORY)(
    HANDLE hToken,
    LPTSTR lpProfileDir,
    LPDWORD lpcchSize
    );
...
#define DECLARE_NAMEOF_API_EXPANDENVIRONMENTSTRINGSFORUSERA CHAR NAMEOF_API_EXPANDENVIRONMENTSTRINGSFORUSERA[] = { 'E', 'x', 'p', 'a', 'n', 'd', 'E', 'n', 'v', 'i', 'r', 'o', 'n', 'm', 'e', 'n', 't', 'S', 't', 'r', 'i', 'n', 'g', 's', 'F', 'o', 'r', 'U', 's', 'e', 'r', 'A', 0, };
/* "ExpandEnvironmentStringsForUserW" */
#define DECLARE_NAMEOF_API_EXPANDENVIRONMENTSTRINGSFORUSERW CHAR NAMEOF_API_EXPANDENVIRONMENTSTRINGSFORUSERW[] = { 'E', 'x', 'p', 'a', 'n', 'd', 'E', 'n', 'v', 'i', 'r', 'o', 'n', 'm', 'e', 'n', 't', 'S', 't', 'r', 'i', 'n', 'g', 's', 'F', 'o', 'r', 'U', 's', 'e', 'r', 'W', 0, };

/* @brief
    Expands the source string by using the environment block established for the specified user.
 */
typedef BOOL (__stdcall *EXPANDENVIRONMENTSTRINGSFORUSERA)(
    HANDLE hToken,
    LPCSTR lpSrc,
    LPSTR lpDest,
    DWORD dwSize
...
typedef BOOL (__stdcall *EXPANDENVIRONMENTSTRINGSFORUSERW)(
    HANDLE hToken,
    LPCWSTR lpSrc,
    LPWSTR lpDest,
    DWORD dwSize
...
#define DECLARE_NAMEOF_API_GETUSERPROFILEDIRECTORYA CHAR NAMEOF_API_GETUSERPROFILEDIRECTORYA[] = { 'G', 'e', 't', 'U', 's', 'e', 'r', 'P', 'r', 'o', 'f', 'i', 'l', 'e', 'D', 'i', 'r', 'e', 'c', 't', 'o', 'r', 'y', 'A', 0, };
/* "GetUserProfileDirectoryW" */
#define DECLARE_NAMEOF_API_GETUSERPROFILEDIRECTORYW CHAR NAMEOF_API_GETUSERPROFILEDIRECTORYW[] = { 'G', 'e', 't', 'U', 's', 'e', 'r', 'P', 'r', 'o', 'f', 'i', 'l', 'e', 'D', 'i', 'r', 'e', 'c', 't', 'o', 'r', 'y', 'W', 0, };

/* @brief
    Frees environment variables created by the CreateEnvironmentBlock function.
 */
typedef BOOL (__stdcall *DESTROYENVIRONMENTBLOCK)(
    LPVOID lpEnvironment
    );
