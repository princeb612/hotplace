...
#ifndef __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_SECUR32__
#define __HOTPLACE_SDK_IO_SYSTEM_WINDOWS_SDK_SECUR32__

#include <Ntsecapi.h>

/* "LsaEnumerateLogonSessions" */
#define DECLARE_NAMEOF_API_LSAENUMERATELOGONSESSIONS char NAMEOF_API_LSAENUMERATELOGONSESSIONS[] = { 'L', 's', 'a', 'E', 'n', 'u', 'm', 'e', 'r', 'a', 't', 'e', 'L', 'o', 'g', 'o', 'n', 'S', 'e', 's', 's', 'i', 'o', 'n', 's', 0, };
/* "LsaGetLogonSessionData" */
#define DECLARE_NAMEOF_API_LSAGETLOGONSESSIONDATA char NAMEOF_API_LSAGETLOGONSESSIONDATA[] = { 'L', 's', 'a', 'G', 'e', 't', 'L', 'o', 'g', 'o', 'n', 'S', 'e', 's', 's', 'i', 'o', 'n', 'D', 'a', 't', 'a', 0, };
/* "LsaFreeReturnBuffer" */
#define DECLARE_NAMEOF_API_LSAFREERETURNBUFFER char NAMEOF_API_LSAFREERETURNBUFFER[] = { 'L', 's', 'a', 'F', 'r', 'e', 'e', 'R', 'e', 't', 'u', 'r', 'n', 'B', 'u', 'f', 'f', 'e', 'r', 0, };
 ...
 */
typedef NTSTATUS (NTAPI *LSAENUMERATELOGONSESSIONS)
(
 ...
 */
typedef NTSTATUS (NTAPI *LSAGETLOGONSESSIONDATA)(
    IN PLUID LogonId,
 ...
 */
typedef NTSTATUS (NTAPI *LSAFREERETURNBUFFER)(
    IN PVOID Buffer
    );
