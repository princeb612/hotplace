...
#endif
{
    ...
    __try2
    {
        ret = RegSetValueEx (hkey, value, 0, type, (LPBYTE) data_ptr, cbsize);
    }
    __finally2
    {
        if (errorcode_t::success != ret) {
...
#endif
{
    ...
    __try2
    {
        ret = RegQueryValueEx (hkey, value, nullptr, type_ptr, (LPBYTE) data_ptr, data_cbsize_ptr);
    }
    __finally2
    {
        if (errorcode_t::success != ret) {
...
#endif
{
    ...
    __try2
    {
        ...
        if (0 == _tcslen (sub_key)) {
            if ((HKEY_CLASSES_ROOT == hrootkey) || (HKEY_CURRENT_USER == hrootkey) || (HKEY_LOCAL_MACHINE == hrootkey) ||
                (HKEY_USERS == hrootkey) || (HKEY_CURRENT_CONFIG == hrootkey)) {
                ret = errorcode_t::invalid_parameter;
                __leave2;
            }
        }
