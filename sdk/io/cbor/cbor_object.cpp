...
cbor_object::cbor_object() : _type(cbor_type_t::cbor_type_null), _flags(0), _tagged(false), _tag(cbor_tag_t(0)), _reserved_size(0) { _shared.make_share(this); }
...
bool cbor_object::tagged() { return _tagged; }
