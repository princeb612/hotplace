...
/**
 * @file   trial_dtls_server_socket.cpp
...
trial_dtls_server_socket::trial_dtls_server_socket(tls_version_t minspec, tls_version_t maxspec) : naive_udp_server_socket(), _minspec(minspec), _maxspec(maxspec) {}
