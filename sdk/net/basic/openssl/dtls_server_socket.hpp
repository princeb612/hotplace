...
#ifndef __HOTPLACE_SDK_NET_BASIC_OPENSSL_DTLSSERVERSOCKET__
#define __HOTPLACE_SDK_NET_BASIC_OPENSSL_DTLSSERVERSOCKET__

#include <sdk/net/basic/naive/udp_server_socket.hpp>  // udp_server_socket
...
class dtls_server_socket : public udp_server_socket {
   public:
    dtls_server_socket(openssl_tls* tls);
