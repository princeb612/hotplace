...
#ifndef __HOTPLACE_SDK_NET_BASIC_OPENSSL_DTLSCLIENTSOCKET__
#define __HOTPLACE_SDK_NET_BASIC_OPENSSL_DTLSCLIENTSOCKET__

#include <sdk/net/basic/naive/udp_client_socket.hpp>  // udp_client_socket
