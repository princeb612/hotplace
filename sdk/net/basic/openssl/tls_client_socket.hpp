...
#ifndef __HOTPLACE_SDK_NET_BASIC_OPENSSL_TLSCLIENTSOCKET__
#define __HOTPLACE_SDK_NET_BASIC_OPENSSL_TLSCLIENTSOCKET__

#include <sdk/net/basic/naive/tcp_client_socket.hpp>  // tcp_client_socket
