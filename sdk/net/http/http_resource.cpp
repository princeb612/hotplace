...
void http_resource::for_each_hpack_static_table(std::function<void(uint32 index, const char* name, const char* value)> func) {
    ...
    struct static_table_entry {
        ...
        {1, ":authority", nullptr, ENDOF_DATA},
        {2, ":method", "GET", ENDOF_DATA},
        {3, ":method", "POST", ENDOF_DATA},
        {4, ":path", "/", ENDOF_DATA},
        {5, ":path", "/index.html", ENDOF_DATA},
        {6, ":scheme", "http", ENDOF_DATA},
        {7, ":scheme", "https", ENDOF_DATA},
        {8, ":status", "200", ENDOF_DATA},
        {9, ":status", "204", ENDOF_DATA},
        {10, ":status", "206", ENDOF_DATA},
        {11, ":status", "304", ENDOF_DATA},
        {12, ":status", "400", ENDOF_DATA},
        {13, ":status", "404", ENDOF_DATA},
        {14, ":status", "500", ENDOF_DATA},
        {15, "accept-charset", nullptr, ENDOF_DATA},
        {16, "accept-encoding", "gzip,deflate", ENDOF_DATA},
        {17, "accept-language", nullptr, ENDOF_DATA},
        {18, "accept-ranges", nullptr, ENDOF_DATA},
        {19, "accept", nullptr, ENDOF_DATA},
        {20, "access-control-allow-origin", nullptr, ENDOF_DATA},
        {21, "age", nullptr, ENDOF_DATA},
        {22, "allow", nullptr, ENDOF_DATA},
        {23, "authorization", nullptr, ENDOF_DATA},
        {24, "cache-control", nullptr, ENDOF_DATA},
        {25, "content-disposition", nullptr, ENDOF_DATA},
        {26, "content-encoding", nullptr, ENDOF_DATA},
        {27, "content-language", nullptr, ENDOF_DATA},
        {28, "content-length", nullptr, ENDOF_DATA},
        {29, "content-location", nullptr, ENDOF_DATA},
        {30, "content-range", nullptr, ENDOF_DATA},
        {31, "content-type", nullptr, ENDOF_DATA},
        {32, "cookie", nullptr, ENDOF_DATA},
        {33, "date", nullptr, ENDOF_DATA},
        {34, "etag", nullptr, ENDOF_DATA},
        {35, "expect", nullptr, ENDOF_DATA},
        {36, "expires", nullptr, ENDOF_DATA},
        {37, "from", nullptr, ENDOF_DATA},
        {38, "host", nullptr, ENDOF_DATA},
        {39, "if-match", nullptr, ENDOF_DATA},
        {40, "if-modified-since", nullptr, ENDOF_DATA},
        {41, "if-none-match", nullptr, ENDOF_DATA},
        {42, "if-range", nullptr, ENDOF_DATA},
        {43, "if-unmodified-since", nullptr, ENDOF_DATA},
        {44, "last-modified", nullptr, ENDOF_DATA},
        {45, "link", nullptr, ENDOF_DATA},
        {46, "location", nullptr, ENDOF_DATA},
        {47, "max-forwards", nullptr, ENDOF_DATA},
        {48, "proxy-authenticate", nullptr, ENDOF_DATA},
        {49, "proxy-authorization", nullptr, ENDOF_DATA},
        {50, "range", nullptr, ENDOF_DATA},
        {51, "referer", nullptr, ENDOF_DATA},
        {52, "refresh", nullptr, ENDOF_DATA},
        {53, "retry-after", nullptr, ENDOF_DATA},
        {54, "server", nullptr, ENDOF_DATA},
        {55, "set-cookie", nullptr, ENDOF_DATA},
        {56, "strict-transport-security", nullptr, ENDOF_DATA},
        {57, "transfer-encoding", nullptr, ENDOF_DATA},
        {58, "user-agent", nullptr, ENDOF_DATA},
        {59, "vary", nullptr, ENDOF_DATA},
        {60, "via", nullptr, ENDOF_DATA},
        {61, "www-authenticate", nullptr, ENDOF_DATA},
    };
