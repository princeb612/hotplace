...
http2_frame_rst_stream::http2_frame_rst_stream() : http2_frame_header(h2_frame_t::h2_frame_rst_stream), _errorcode(0) {}

http2_frame_rst_stream::http2_frame_rst_stream(const http2_frame_rst_stream& rhs) : http2_frame_header(rhs), _errorcode(rhs._errorcode) {}
