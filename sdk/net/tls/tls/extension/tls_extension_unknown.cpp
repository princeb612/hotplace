...
/**
 * @file   tls_extension_unknown.cpp
...
return_t tls_extension_unknown::do_read_body(tls_direction_t dir, const byte_t* stream, size_t size, size_t& pos) { return errorcode_t::success; }

return_t tls_extension_unknown::do_write_body(tls_direction_t dir, binary_t& bin) { return errorcode_t::success; }
