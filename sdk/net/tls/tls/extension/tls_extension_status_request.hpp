...
/**
 * @file   tls_extension_status_request.hpp
...
class tls_extension_status_request : public tls_extension {
   public:
    ...
    uint8 get_cert_status_type() const;
    void set_responderid_info(const binary_t& info);
    const binary_t& get_responderid_info() const;
    void set_request_ext_info(const binary_t& info);
    const binary_t& get_request_ext_info() const;
