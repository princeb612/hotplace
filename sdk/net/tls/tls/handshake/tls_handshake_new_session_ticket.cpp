...
/**
 * @file   tls_handshake_new_session_ticket.cpp
...
tls_handshake_new_session_ticket::tls_handshake_new_session_ticket(tls_session* session) : tls_handshake(tls_handshake_type_t::new_session_ticket, session) {}
