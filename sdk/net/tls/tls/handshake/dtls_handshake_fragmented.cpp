...
/**
 * @file   dtls_handshake_fragmented.cpp
...
dtls_handshake_fragmented::dtls_handshake_fragmented(tls_handshake_type_t type, tls_session* session) : tls_handshake(type, session) {
