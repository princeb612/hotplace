...
/**
 * @file   tls_handshake_encrypted_extensions.hpp
 * @author Soo Han, Kim (princeb612.kr@gmail.com)
 * @desc
 *
 */

#ifndef __HOTPLACE_SDK_NET_TLS_TLS_HANDSHAKE_TLSHANDSHAKEENCRYPTEDEXTENSIONS__
#define __HOTPLACE_SDK_NET_TLS_TLS_HANDSHAKE_TLSHANDSHAKEENCRYPTEDEXTENSIONS__
