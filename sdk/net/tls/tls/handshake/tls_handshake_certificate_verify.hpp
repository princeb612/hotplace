...
/**
 * @file   tls_handshake_certificate_verify.hpp
...
class tls_handshake_certificate_verify : public tls_handshake {
   ...
   protected:
    ...
    return_t sign_certverify(const EVP_PKEY* pkey, tls_direction_t dir, tls_sigscheme_t& scheme, binary_t& signature);
    return_t verify_certverify(const EVP_PKEY* pkey, tls_direction_t dir, tls_sigscheme_t scheme, const binary_t& signature);
};
