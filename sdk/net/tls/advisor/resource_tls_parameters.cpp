...
const tls_group_t tls_groups[] = {
    ...
    {
        tls_named_group_brainpoolP256r1tls13,
        0,
    ...
    {
        tls_named_group_brainpoolP384r1tls13,
        0,
    ...
    {
        tls_named_group_brainpoolP512r1tls13,
        0,
...
#define FLAG_SUPPORT_PQC tls_flag_support
#else
