...
tls_ack::tls_ack(tls_session* session) : tls_record(tls_content_type_ack, session) {}

return_t tls_ack::read_data(tls_direction_t dir, const byte_t* stream, size_t size, size_t& pos, stream_t* debugstream) {
...
return_t tls_ack::write(tls_direction_t dir, binary_t& bin, stream_t* debugstream) { return errorcode_t::not_supported; }
