...
class crypto_key {
   public:
     ...
     *          | kty_mlkem  | crypt_item_t::pub_key             | crypt_item_t::privekey    |
     *          | kty_mldsa  | crypt_item_t::pub_key             | crypt_item_t::privekey    |
     *          | kty_slhdsa | crypt_item_t::pub_key             | crypt_item_t::privekey    |
     *
