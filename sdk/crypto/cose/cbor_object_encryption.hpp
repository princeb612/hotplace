...
/**
 * @file   cbor_object_encryption.hpp
...
class cbor_object_encryption {
   public:
    ...
    ~cbor_object_encryption() = default;
     ...
     */
    static return_t encrypt(cose_context_t* handle, crypto_key* key, cose_alg_t method, const binary_t& input, binary_t& output);
    /**
     ...
     */
    static return_t encrypt(cose_context_t* handle, crypto_key* key, std::list<cose_alg_t> methods, const binary_t& input, binary_t& output);
    /**
     * @brief   encrypt
     * @param   cose_context_t* handle [in]
     * @param   crypto_key* key [in]
     ...
     */
    static return_t encrypt(cose_context_t* handle, crypto_key* key, cose_alg_t* methods, size_t size_method, const binary_t& input, binary_t& output);
    /**
     * @brief   decrypt
     * @param   cose_context_t* handle [in]
     * @param   crypto_key* key [in]
     ...
     * @return  error code (see error.hpp)
     */
    static return_t decrypt(cose_context_t* handle, crypto_key* key, const binary_t& input, binary_t& output, bool& result);
