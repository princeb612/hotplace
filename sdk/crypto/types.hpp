...
// tls_named_curve_t - TLS Supported Groups
///////////////////////////////////////////////////////////////////////////
/**
...
enum tls_named_curve_t : uint16 {
    ...
    // https://www.iana.org/assignments/tls-parameters/tls-parameters.xhtml
    tls_named_curve_sect163k1 = 0x0001,
    tls_named_curve_sect163r1 = 0x0002,
    tls_named_curve_sect163r2 = 0x0003,
    tls_named_curve_sect193r1 = 0x0004,
    tls_named_curve_sect193r2 = 0x0005,
    tls_named_curve_sect233k1 = 0x0006,
    tls_named_curve_sect233r1 = 0x0007,
    tls_named_curve_sect239k1 = 0x0008,
    tls_named_curve_sect283k1 = 0x0009,
    tls_named_curve_sect283r1 = 0x000a,             // 10
    tls_named_curve_sect409k1 = 0x000b,             // 11
    tls_named_curve_sect409r1 = 0x000c,             // 12
    tls_named_curve_sect571k1 = 0x000d,             // 13
    tls_named_curve_sect571r1 = 0x000e,             // 14
    tls_named_curve_secp160k1 = 0x000f,             // 15
    tls_named_curve_secp160r1 = 0x0010,             // 16
    tls_named_curve_secp160r2 = 0x0011,             // 17
    tls_named_curve_secp192k1 = 0x0012,             // 18
    tls_named_curve_secp192r1 = 0x0013,             // 19
    tls_named_curve_secp224k1 = 0x0014,             // 20
    tls_named_curve_secp224r1 = 0x0015,             // 21
    tls_named_curve_secp256k1 = 0x0016,             // 22
    tls_named_curve_secp256r1 = 0x0017,             // 23
    tls_named_curve_secp384r1 = 0x0018,             // 24
    tls_named_curve_secp521r1 = 0x0019,             // 25
    tls_named_curve_brainpoolP256r1 = 0x001a,       // 26
    tls_named_curve_brainpoolP384r1 = 0x001b,       // 27
    tls_named_curve_brainpoolP512r1 = 0x001c,       // 28
    tls_named_curve_x25519 = 0x001d,                // 29
    tls_named_curve_x448 = 0x001e,                  // 30
    tls_named_curve_brainpoolP256r1tls13 = 0x001f,  // 31
    tls_named_curve_brainpoolP384r1tls13 = 0x0020,  // 32
    tls_named_curve_brainpoolP512r1tls13 = 0x0021,  // 33
    tls_named_curve_GC256A = 0x0022,                // 34
    tls_named_curve_GC256B = 0x0023,                // 35
    tls_named_curve_GC256C = 0x0024,                // 36
    tls_named_curve_GC256D = 0x0025,                // 37
    tls_named_curve_GC512A = 0x0026,                // 38
    tls_named_curve_GC512B = 0x0027,                // 39
    tls_named_curve_GC512C = 0x0028,                // 40
    tls_named_curve_curveSM2 = 0x0029,              // 41, not recommended
    tls_named_curve_ffdhe2048 = 0x0100,             // 256
    tls_named_curve_ffdhe3072 = 0x0101,             // 257
