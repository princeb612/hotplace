...
/**
 * @file   json_object_signing_encryption.hpp
...
class json_object_signing_encryption {
   ...
   public:
     ...
     */
    static return_t open(jose_context_t** context, crypto_key* crypto_key);
    /**
     * @brief close
     * @param jose_context_t* context [in]
     * @return error code (see error.hpp)
     */
    static return_t close(jose_context_t* context);
     ...
     * @return error code (see error.hpp)
     */
    static return_t setoption(jose_context_t* context, uint32 flags);
    ...
    static return_t encrypt(jose_context_t* context, jwe_t enc, jwa_t alg, const std::string& input, std::string& output,
                            jose_serialization_t type = jose_serialization_t::jose_compact);
    static return_t encrypt2(jose_context_t* context, const std::string& enc, const std::string& alg, const binary_t& input, std::string& output,
                             jose_serialization_t type = jose_serialization_t::jose_compact);
    static return_t encrypt2(jose_context_t* context, const std::string& enc, const std::string& alg, const std::string& input, std::string& output,
                             jose_serialization_t type = jose_serialization_t::jose_compact);
    /**
     * @brief encrypt
     * @param jose_context_t* context [in]
    ...
    static return_t encrypt(jose_context_t* context, jwe_t enc, const std::list<jwa_t>& algs, const std::string& input, std::string& output,
                            jose_serialization_t type = jose_serialization_t::jose_compact);
    static return_t encrypt2(jose_context_t* context, const std::string& enc, const std::list<std::string>& algs, const binary_t& input, std::string& output,
                             jose_serialization_t type = jose_serialization_t::jose_compact);
    static return_t encrypt2(jose_context_t* context, const std::string& enc, const std::list<std::string>& algs, const std::string& input, std::string& output,
                             jose_serialization_t type = jose_serialization_t::jose_compact);
    /**
     * @brief decrypt
     * @param jose_context_t* context [in]
    ...
    static return_t sign(jose_context_t* context, jws_t method, const std::string& input, std::string& output,
                         jose_serialization_t type = jose_serialization_t::jose_compact);
    static return_t sign2(jose_context_t* context, const std::string& method, const std::string& input, std::string& output,
                          jose_serialization_t type = jose_serialization_t::jose_compact);
    /**
     * @brief sign
     * @param jose_context_t* context [in]
    ...
    static return_t sign(jose_context_t* context, std::list<jws_t> const& methods, const std::string& input, std::string& output,
                         jose_serialization_t type = jose_serialization_t::jose_compact);
    static return_t sign2(jose_context_t* context, std::list<std::string> const& methods, const std::string& input, std::string& output,
                          jose_serialization_t type = jose_serialization_t::jose_compact);
    /**
     * @brief sign
     * @param jose_context_t* context [in]
