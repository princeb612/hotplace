...
void test_crypto_key() {
    ...
    // public, private
    keychain.add_ec_b64u(&key, "11", nullptr, "P-256", "usWxHK2PmfnHKwXPS54m0kTcGJ90UiglWiGahtagnv8", "IBOL-C3BttVivg-lSreASjpkttcsz-1rb7btKLv8EX4",
                         "V8kgd2ZBRuh2dgyVINBUqpPDr7BOMGcF22CQMIUHtNM");
    keychain.add_ec_b64u(&key, "P384", nullptr, "P-384", "kTJyP2KSsBBhnb4kjWmMF7WHVsY55xUPgb7k64rDcjatChoZ1nvjKmYmPh5STRKc",
    ...
    keychain.add_ec_b64u(&key, "bilbo.baggins@hobbiton.example", "ES512", "P-521",
    ...
    keychain.add_ec_b16(&key, "11", "EdDSA", "Ed25519", "d75a980182b10ab7d54bfed3c964073a0ee172f3daa62325af021a68f707511a", "",
                        "9d61b19deffd5a60ba844af492ec2cc44449c5697b326919703bac031cae7f60");
    keychain.add_ec_b16(&key, "ed448", "EdDSA", "Ed448",
                        "5fd7449b59b461fd2ce787ec616ad46a1da1342485a70e1f8a0ea75d80e96778edf124769b46c7061bd6783df1e50f6cd1fa1abeafe8256180", "",
                        "6c82a562cb808d10d632be89c8513ebf6c929f34ddfa8c9f63c9960ef6e348a3528c8a3fcc2f044e39a3fc5b94492f8f032e7549a20098f95b");
    keychain.add_ec_b16(&key, "Alice Lovelace", "ES256", "P-256", "863aa7bc0326716aa59db5bf66cc660d0591d51e4891bc2e6a9baff5077d927c",
    ...
    keychain.add_ec_b16(&key, "X25519-1", "X25519", "X25519", "7FFE91F5F932DAE92BE603F55FAC0F4C4C9328906EE550EDCB7F6F7626EBC07E", "",
                        "00a943daa2e38b2edbf0da0434eaaec6016fe25dcd5ecacbc07dc30300567655");
    keychain.add_oct_b64u(&key, "our-secret", nullptr, "hJtXIZ2uSN5kbQfbtTNWbpdmhkV8FJG-Onbc6mxCcYg", crypto_use_t::use_enc);
    keychain.add_oct_b64u(&key, "sec-48", nullptr, "hJtXIZ2uSN5kbQfbtTNWbpdmhkV8FJG-Onbc6mxCcYgAESIzd4iZqiEiIyQlJico", crypto_use_t::use_enc);
    keychain.add_oct_b64u(&key, "sec-64", nullptr, "hJtXIZ2uSN5kbQfbtTNWbpdmhkV8FJG-Onbc6mxCcYgAESIzd4iZqiEiIyQlJicoqrvM3e7_paanqKmgsbKztA",
                          crypto_use_t::use_enc);
    keychain.add_rsa_b16(
        &key, "meriadoc.brandybuck@rsa.example", nullptr,
    ...
    auto dump_crypto_key = [&](crypto_key_object* item, void*) -> void {
        bs.printf(R"(> kid "%s")", item->get_kid());
        bs.printf("\n");
