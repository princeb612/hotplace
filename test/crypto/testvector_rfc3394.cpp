...
const test_vector_rfc3394_t test_vector_rfc3394[] = {
    {// RFC 3394 4.1 Wrap 128 bits of Key Data with a 128-bit KEK
     ...
     crypt_algorithm_t::aes128, "aes-128-wrap", "000102030405060708090A0B0C0D0E0F", "00112233445566778899AABBCCDDEEFF",
     "1FA68B0A8112B447AEF34BD8FB5A7B829D3E862371D2CFE5", "RFC 3394 4.1 Wrap 128 bits of Key Data with a 128-bit KEK"},
    {// RFC 3394 4.2 Wrap 128 bits of Key Data with a 192-bit KEK
     // KEK 000102030405060708090A0B0C0D0E0F1011121314151617
     // Key Data 00112233445566778899AABBCCDDEEFF
     // Ciphertext: 96778B25AE6CA435F92B5B97C050AED2468AB8A17AD84E5D
     crypt_algorithm_t::aes192, "aes-192-wrap", "000102030405060708090A0B0C0D0E0F1011121314151617", "00112233445566778899AABBCCDDEEFF",
    ...
    {// RFC 3394 4.3 Wrap 128 bits of Key Data with a 256-bit KEK
     ...
     crypt_algorithm_t::aes256, "aes-256-wrap", "000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F", "00112233445566778899AABBCCDDEEFF",
    ...
    {// RFC 3394 4.4 Wrap 192 bits of Key Data with a 192-bit KEK
     ...
     crypt_algorithm_t::aes192, "aes-192-wrap", "000102030405060708090A0B0C0D0E0F1011121314151617", "00112233445566778899AABBCCDDEEFF0001020304050607",
    ...
    {// RFC 3394 4.5 Wrap 192 bits of Key Data with a 256-bit KEK
     ...
     crypt_algorithm_t::aes256, "aes-256-wrap", "000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F",
     "00112233445566778899AABBCCDDEEFF0001020304050607", "A8F9BC1612C68B3FF6E6F4FBE30E71E4769C8B80A32CB8958CD5D17D6B254DA1",
     "RFC 3394 4.5 Wrap 192 bits of Key Data with a 256-bit KEK"},
