...
void test_rfc7517_C() {
    ...
    keygen.add_oct(&key, jwa_t::pbes2_hs256_a128kw, to_binary(passphrase), keydesc(crypto_use_t::use_enc));

    jose.open(&context, &key);
    jose.encrypt(context, jwe_t::a128cbc_hs256, jwa_t::pbes2_hs256_a128kw, to_binary(input), output, jose_serialization_t::jose_compact);
