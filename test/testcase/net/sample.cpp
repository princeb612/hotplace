...
int main(int argc, char** argv) {
    ...
    (*_cmdline)
        ...
        << t_cmdarg_t<OPTION>("-c", "connect", [](OPTION& o, const char* param) -> void { o.connect = 1; }).optional()
        << t_cmdarg_t<OPTION>("-p", "read stream using http_protocol", [](OPTION& o, const char* param) -> void { o.mode = 1; }).optional()
        << t_cmdarg_t<OPTION>("-u", "url (default https://localhost:9000/) feat. httptest1", [](OPTION& o, const char* param) -> void { o.url = param; })
               .preced()
               .optional();
