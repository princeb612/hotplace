...
void test_rfc8152_c_3_2() {
    ...
    cose.set(cose_handle, cose_param_t::cose_unsent_apu_id, strtobin("lighting-client"));
    cose.set(cose_handle, cose_param_t::cose_unsent_apv_id, strtobin("lighting-server"));
    cose.set(cose_handle, cose_param_t::cose_unsent_pub_other, strtobin("Encryption Example 02"));
...
void test_rfc8152_c_7_1() {
    ...
    cbor_array* root = new cbor_array();
    {
        ...
        *key << new cbor_pair(cose_key_lable_t::cose_ec_crv, new cbor_data(cose_ec_curve_t::cose_ec_p256))
             ...
             << new cbor_pair(cose_key_lable_t::cose_lable_kid, new cbor_data(strtobin("meriadoc.brandybuck@buckland.example")));
    ...
    }
    {
        ...
        *key << new cbor_pair(cose_key_lable_t::cose_ec_crv, new cbor_data(cose_ec_curve_t::cose_ec_p256))
             ...
             << new cbor_pair(cose_key_lable_t::cose_lable_kty, new cbor_data(cose_kty_t::cose_kty_ec2))
             << new cbor_pair(cose_key_lable_t::cose_lable_kid, new cbor_data(strtobin("11")));
    ...
    }
    {
        ...
        *key
            ...
            << new cbor_pair(cose_key_lable_t::cose_lable_kty, new cbor_data(cose_kty_t::cose_kty_ec2))
            << new cbor_pair(cose_key_lable_t::cose_lable_kid, new cbor_data(strtobin("bilbo.baggins@hobbiton.example")));
    ...
    }
    {
        ...
        *key << new cbor_pair(cose_key_lable_t::cose_ec_crv, new cbor_data(cose_ec_curve_t::cose_ec_p256))
             ...
             << new cbor_pair(cose_key_lable_t::cose_lable_kty, new cbor_data(cose_kty_t::cose_kty_ec2))
             << new cbor_pair(cose_key_lable_t::cose_lable_kid, new cbor_data(strtobin("peregrin.took@tuckborough.example")));
...
void test_rfc8152_c_7_2() {
    ...
    }
    {
        ...
        *key << new cbor_pair(cose_key_lable_t::cose_lable_kty, new cbor_data(cose_kty_t::cose_kty_symm))
             << new cbor_pair(cose_key_lable_t::cose_lable_kid, new cbor_data(strtobin("our-secret")))
    ...
    }
    {
        ...
        *key << new cbor_pair(cose_key_lable_t::cose_lable_kty, new cbor_data(cose_kty_t::cose_kty_symm))
             << new cbor_pair(cose_key_lable_t::cose_lable_kid, new cbor_data(strtobin("our-secret2")))
    ...
    }
    {
        ...
        *key << new cbor_pair(cose_key_lable_t::cose_lable_kty, new cbor_data(cose_kty_t::cose_kty_symm))
             << new cbor_pair(cose_key_lable_t::cose_lable_kid, new cbor_data(strtobin("018c0ae5-4d9b-471b-bfd6-eef314bc7037")))
             << new cbor_pair(cose_key_lable_t::cose_symm_k, new cbor_data(base16_decode("849b57219dae48de646d07dbb533566e976686457c1491be3a76dcea6c427188")));
...
void test_jose_from_cwk() {
    ...
    ret = cose.sign(handle, &privkey, algs, strtobin(input), signature);
...
void test_selfgen(crypto_key* key) {
    ...
    crypto_advisor* advisor = crypto_advisor::get_instance();
    binary_t input = strtobin("hello world");
    std::list<cose_alg_t> algs;
    size_t i = 0;
    size_t j = 0;
