...
void test_rfc8152_c_3_4() {
    ...
    *root << cbor_data_protected    // protected
    ...
    cose_context_t* cose_handle = nullptr;
    cose.open(&cose_handle);
    cose.set(cose_handle, cose_param_t::cose_shared_external, base16_decode("0011bbcc22dd44ee55ff660077"));
    ...
    // hashsig
      ...
      },
      {
        ...
        // RFC8152
        {
            ...
            "Triple layer encryption example",
        ...
        },
        {
            ...
            "JOSE Cookbook Example 4.2 - RSA-PSS signature",
        ...
        },
        {
            ...
            "JOSE Cookbook Example 4.8 - multiple signatures",
        ...
        },
        {
            ...
            "SIG-03:  Counter Signature example",
        ...
        },
        {
            ...
            "Sig-04: Add crit flag and origination time",
