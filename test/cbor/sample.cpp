...
void test3() {
    ...
    // {"a":1,"b":[2,3]}
    test_parse("a26161016162820203", R"({"a":1,"b":[2,3]})");
    // ["a",{"b":"c"}]
    test_parse("826161a161626163", R"(["a",{"b":"c"}])");
    // {"a": "A", "b": "B", "c": "C", "d": "D", "e": "E"}
    test_parse("a56161614161626142616361436164614461656145", R"({"a": "A", "b": "B", "c": "C", "d": "D", "e": "E"})");
    // (_ h'0102', h'030405')
    test_parse("5f42010243030405ff", "(_ h'0102', h'030405')");
    // (_ "strea", "ming")
    test_parse("7f657374726561646d696e67ff", R"((_ "strea", "ming"))");
    // [_ ]
    test_parse("9fff", "[_ ]");
    // [_ 1,[2,3],[_ 4,5]]
    ...
    // {_ "a":1,"b":[_ 2,3]}
    test_parse("bf61610161629f0203ffff", R"({_ "a":1,"b":[_ 2,3]})");
    // ["a",{_ "b":"c"}]
    test_parse("826161bf61626163ff", R"(["a",{_ "b":"c"}])");
    // {_ "Fun":true,"Amt":-2}
    test_parse("bf6346756ef563416d7421ff", R"({_ "Fun":true,"Amt":-2})");
}
