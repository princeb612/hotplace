...
return_t async_handler (netsocket_event_t* netsocket_context)
{
    ...
    WSARecv (netsocket_context->client_socket, &(netsocket_context->netio_read.wsabuf), 1, &bytes_received, &flags,
             &(netsocket_context->netio_read.overlapped), nullptr); /* asynchronus read */
#endif
