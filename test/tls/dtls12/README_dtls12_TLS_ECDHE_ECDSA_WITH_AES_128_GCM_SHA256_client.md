...
````
openssl s_client -connect localhost:9000 -state -debug -keylogfile sslkeylog -dtls1_2 -ciphersuites TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256
Connecting to ::1
CONNECTED(000001E4)
SSL_connect:before SSL initialization
write to 0x1d8a5301ef0 [0x1d8a56f8200] (208 bytes => 208 (0xD0))
...
write to 0x1d8a5301ef0 [0x1d8a56f8200] (53 bytes => 53 (0x35))
...
0030 - 02 05 02 06 02                                    .....
SSL_connect:SSLv3/TLS write client hello
read from 0x1d8a5301ef0 [0x1d8a56fd2f3] (16717 bytes => 208 (0xD0))
...
depth=0 C=KR, ST=GG, L=YI, O=Test, OU=Test, CN=Test
verify return:1
read from 0x1d8a5301ef0 [0x1d8a56fd2f3] (16717 bytes => 204 (0xCC))
...
read from 0x1d8a5301ef0 [0x1d8a56fd2f3] (16717 bytes => 25 (0x19))
...
write to 0x1d8a5301ef0 [0x1d8a56f8200] (133 bytes => 133 (0x85))
...
read from 0x1d8a5301ef0 [0x1d8a56fd2f3] (16717 bytes => 207 (0xCF))
...
SSL_connect:SSLv3/TLS write finished
read from 0x1d8a5301ef0 [0x1d8a56fd2f3] (16717 bytes => 75 (0x4B))
...
---
SSL handshake has read 1807 bytes and written 635 bytes
...
SSL-Session:
    ...
    Session-ID: E9D4C2345633F0C91F78E6A19A13C032DBEE918B76BFA9F0610D3531CFF6F226
    Session-ID-ctx:
    Master-Key: E4FEE12A44EA9B47AF65F83485AA5D44D4796E6CDD66781B6B00DA1F774F054489C76471A0AE2E7E236F2F5E2A71C448
    PSK identity: None
    PSK identity hint: None
    SRP username: None
    TLS session ticket lifetime hint: 7200 (seconds)
    TLS session ticket:
    0000 - 27 23 a6 f5 8f 44 7e 30-d9 73 ee f4 4e 25 0c 4c   '#...D~0.s..N%.L
    0010 - fc f3 8e d6 38 38 ae 1c-bb df 12 5d ec 7b 60 5b   ....88.....].{`[
    0020 - c1 c3 f8 99 72 12 d2 6b-13 88 4c 71 90 a3 57 cb   ....r..k..Lq..W.
    0030 - d3 27 31 a4 91 21 7f c6-a0 6d f8 37 06 29 9b e8   .'1..!...m.7.)..
    0040 - 30 df 3f b3 72 59 f0 4a-e1 c6 4b 07 58 df 51 ac   0.?.rY.J..K.X.Q.
    0050 - 30 53 2d bd fb 5d 24 1a-0e 76 24 36 7b 62 55 4c   0S-..]$..v$6{bUL
    0060 - 9d aa 85 db 00 46 81 4e-d9 df c9 c5 9c 22 01 aa   .....F.N....."..
    0070 - 45 0e 3f be 79 80 26 ff-b0 b3 20 19 ad 2d 14 42   E.?.y.&... ..-.B
    0080 - 30 d3 93 1f 3d c4 7c b9-55 65 8e d2 4c 23 50 af   0...=.|.Ue..L#P.
    0090 - 11 76 30 45 49 63 1e e7-ed 53 09 0d e3 cd 45 41   .v0EIc...S....EA
    00a0 - 23 ae 06 ab 6e bc 4c 81-e4 13 d4 c6 2d 96 43 cd   #...n.L.....-.C.

    Start Time: 1749110232
    Timeout   : 7200 (sec)
    Verify return code: 21 (unable to verify the first certificate)
    Extended master secret: yes
---
test
write to 0x1d8a5301ef0 [0x1d8a570ea63] (43 bytes => 43 (0x2B))
...
Q
DONE
write to 0x1d8a5301ef0 [0x1d8a570ea63] (39 bytes => 39 (0x27))
...
read from 0x1d8a5301ef0 [0x1d8a5247c90] (16384 bytes => 39 (0x27))
