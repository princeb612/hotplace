 ...
 * #55      S->C A PKN 27 STREAM(0)
 * #56      S->C A PKN 28 STREAM(0)
 * #57      S->C A PKN 29 STREAM(0)
...
const testvector_http3_t pcap_http3[] = {
    ...
    },
    {
        from_server,
        prot_tls13,
        "WIRESHARK#25 TLS 1.3 SH, CCH, FIN(segment)",
        ...
        // server_hello, change_cipher_spec (133 bytes)
        ...
        "03 03 00 01 01 "
        // TCP segment data (1279 bytes)
        // finished segment
        "17 03 03 0a 76 b1 40 1a a0 33 59"
    ...
    // condition TCP segmentation
    {
        ...
        from_server,
        prot_tls13,
        "WIRESHARK#27 TLS 1.3 FIN(segment)",
        // TCP segment data (1404 bytes)
        "9d e2 68 62 ac 88 87 bb cf c4 9a 6b f1 03 9b 1b"
        "dc 9e 8b 09 d4 f3 ce 7f bb 4b da 68 d7 d7 78 41"
        "13 bd cc 2d 6b d8 85 19 d5 5d 7d e1 bd c8 71 ba"
        "8f e0 4c d3 1b da 3c 8c c5 b9 9c 99 55 8e 9b 58"
        "ab c5 f2 61 1c 7e b1 ac 84 00 4f fd f2 b7 59 94"
        "8f 4b e2 7c 2f 02 ce 87 74 59 45 fc 17 3a da d6"
        "02 25 b9 b1 cb 1c 14 53 fa 01 a4 0a 20 c0 d0 27"
        "79 19 98 67 6a 88 cd e5 9f 47 5d ad 0d 6e e5 3d"
        "16 61 44 21 ab a0 d8 e2 8f bb 7d 58 51 da a1 cb"
        "59 47 3e fb 47 50 eb d3 16 36 75 bc 02 1d e9 90"
        "0a 8c a6 e3 99 aa dd f6 98 33 29 dc c2 7e 17 9f"
        "4d 56 dc ba 94 5a 02 a4 5e 40 75 70 a4 98 a0 e6"
        "6b 81 dc 09 37 a2 84 a1 d6 ae b8 46 c5 7c eb 73"
        "d6 73 24 2b 0b a2 30 20 97 57 51 2b 8c 18 c4 f4"
        "e4 c4 88 b1 77 a0 fa d0 e0 de 1f b0 da ef c3 cf"
        "ba cb 69 61 78 d7 15 84 a1 8f 7a 45 75 ce b0 41"
        "53 6a 7f 64 28 8b 6d 2d 06 f4 21 4a f6 7c 8d c3"
        "df 15 ff 81 f1 d7 84 9a 8e 51 a3 03 76 b0 7e 1f"
        "53 88 c8 ae eb 9b 6b 19 07 67 42 bc 8b 8b b9 76"
        "17 ec 92 8e fb 21 2d b7 8a 91 d7 32 e6 64 4c 84"
        "8e e1 6b 2f af f9 6e 97 27 3a a2 67 3b a7 03 77"
        "12 89 83 3f 6c 40 6a 54 ad f5 95 a2 bf ef 1a 78"
        "4c 10 b8 af ce 6e ff c3 a7 dd 36 fb e9 88 d1 db"
        "35 49 a2 ef c8 60 04 0d 61 33 6a 6d e2 d2 7b 33"
        "86 2f d7 37 3f ad e1 66 67 22 8e 17 b3 44 06 41"
        "39 70 e2 6f 64 3d a4 4a c7 e5 09 51 a2 62 7d c1"
        "31 93 02 81 c0 40 af 15 cb e7 61 40 71 e5 28 5f"
        "5f 9d c7 ec 4f 95 f6 b3 a2 19 df 69 36 27 e6 66"
        "72 6a ee 48 0d ee ad f7 1f 6d 74 bd 9c 87 77 8a"
        "f4 2f f4 42 a7 cd bb 1f 1d 2f 68 ce 9b 3a be 86"
        "45 c6 64 6f d3 fb c8 b8 03 77 2f 02 c4 77 28 51"
        "84 9d c4 60 64 4c 8e 70 92 40 6b 7e b9 ea 8d b2"
        "25 ea de 16 b8 cf cf 00 9c fd f6 01 64 38 9a 7a"
        "50 1d 78 9a a1 22 2e 69 e4 a8 13 dc 0a 3d 43 c3"
        "59 8c 87 0e bd 73 9d cd 96 93 4c 18 77 86 ad 8e"
        "0d e2 e5 78 27 a3 2c aa 1e fe 44 a2 ff d4 db bd"
        "2e fc f9 7c 1c 41 9f cb e4 0e 01 4a c9 96 1f 56"
        "14 a4 59 b2 09 26 0d 07 af ea 06 38 18 21 c2 b3"
        "50 53 11 8d 0a 34 bd b6 cc b7 f7 ee 64 29 4e 23"
        "1b 84 92 e4 ba b6 2b 17 d0 62 14 c2 07 17 03 b6"
        "19 ea 7e 65 3d ed 35 ac 61 8d 98 a3 40 8a c4 77"
        "cc 0b 13 c4 20 23 a3 ca 9b 73 c4 c1 2e 29 7f e6"
        "34 08 7d 74 03 c6 5d 55 8d c7 64 a0 ba ed 8d a4"
        "75 df fe 34 ce db 87 8f 52 52 93 bd 78 19 26 11"
        "10 2d 6c 33 57 e4 b2 c0 79 93 42 a5 8d 2a e1 64"
        "ec 91 91 b9 93 aa ee 20 a3 31 6b ed 5f 9c 3e 1d"
        "46 66 ed de 10 08 de a2 01 bb 36 10 b9 47 71 78"
        "d8 f6 54 45 71 9c 4f 56 1c d5 85 02 85 99 a3 85"
        "9c c5 d0 b1 28 ab e6 9e 33 ae c5 6b 59 4f 6b b8"
        "12 95 83 3e 88 83 cf f0 70 72 a4 3c 08 09 c7 9e"
        "14 0f 6a 54 77 83 f5 f7 26 ce c3 3b 5f e7 27 4e"
        "64 04 61 c8 7a 82 1d f9 3c 2c 24 f6 47 e6 bd e9"
        "a9 96 70 a6 2b bd 45 3f 78 5c 9b ac 2c 63 3d 8d"
        "d4 fa ae 8e ce c6 33 e4 08 76 ee 46 82 6b cc 17"
        "60 91 3c a6 e5 5e 53 18 75 05 4d 6d 36 5f 7e ff"
        "c6 8b 73 bc 0e c7 29 96 f3 e0 b6 39 5e f6 fa d4"
        "42 6f 95 a1 97 9e 60 34 e7 56 98 db 5d dd 5e 98"
        "8b 16 8f cf 92 58 63 31 6d 47 44 16 7b f8 97 b1"
        "63 4a 8e 65 79 2d b7 1d 81 70 bd 75 72 f2 5f 56"
        "78 01 cb 59 f3 be 1e 63 f7 59 ad f1 6f 25 91 5f"
        "e1 9b 86 15 2d 55 56 6e 60 85 29 53 57 df a1 bf"
        "15 c1 3e 7f a6 8d 71 b1 90 a6 46 39 78 a5 b8 d0"
        "87 b1 27 85 a7 3a 7b 6d 96 96 95 32 e8 18 a4 c6"
        "e1 c0 3e 6f 79 69 37 9e 3a 79 3d d8 19 fe 80 83"
        "f5 dd cf 0f 98 3e 1b 98 f8 41 d9 ce 32 ec 41 ca"
        "b1 ca 63 37 58 f7 fe c4 4f bf b9 3e 0f 97 69 c9"
        "26 c7 14 cb ab 8a c4 e1 95 9a 28 8e 7a e3 d4 e5"
        "4c ce 06 31 df 60 08 5f 7e 3d f2 2c 8f 39 5d 8c"
        "b4 fc a6 28 69 f0 55 8a 5a 6e 79 62 42 40 dc 69"
        "6d ec 0c 82 92 93 08 63 1a 78 35 22 69 e7 8e 28"
        "b6 a0 f7 c6 57 e4 5a a3 bb 08 ae 04 61 3d e0 84"
        "7e dc 01 a2 1c dc 6b f5 42 95 69 80 59 af 4e 75"
        "ff 78 61 1a dc eb 77 31 e4 6e f8 6f bf 83 9a 9c"
        "7e a1 32 0f 62 2a 41 19 97 6c 4f 23 9f 36 01 a7"
        "43 07 55 13 83 15 cc ce 0a 02 04 d8 fb 65 e5 54"
        "1e 5c eb 77 d9 47 55 70 aa d1 39 b6 0d a7 20 38"
        "59 64 65 44 51 0b 02 bb 9d 5e 20 5a 14 0e f2 a0"
        "ca 76 e5 ce e8 3a c7 93 e9 93 ee 64 dd 1a 3f 1c"
        "ac ef c4 1b a4 e3 af 7a 43 c8 9b 8b 4c 1a a2 d6"
        "42 92 9b 91 f7 6a f2 61 a1 fe 6c 1b 5b 32 63 d0"
        "a8 59 d1 22 db a9 9c 6e e2 f5 9c 77 76 2d 0c 03"
        "15 6b 6a b9 00 2b 32 c3 2d fd 0b 57 f3 63 d7 dc"
        "72 db a6 27 2b 2f 66 5b d0 ed 97 ad b8 1c 50 3e"
        "35 6f e0 53 d6 ac bd 4c d2 f1 d2 03 63 69 34 3a"
        "f8 a9 82 04 f9 6d 7c 80 f0 b5 cc 3f 02 e5 c5 9e"
        "3b 22 0d ec 43 81 c3 c9 45 15 58 37 b4 96 24 33"
        "63 c7 00 12 1f 2c bc 0b 68 28 ec 7b b6 41 fb 01"
        "2f 90 68 d4 83 92 bf 8b 66 29 9e f9",
    },
#endif
    {
        // QUIC IETF
