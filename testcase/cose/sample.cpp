...
int main(int argc, char** argv) {
    ...
    (*_cmdline) << t_cmdarg_t<OPTION>("-v", "verbose", [](OPTION& o, const char* param) -> void { o.enable_verbose(); }).optional()
                ...
                << t_cmdarg_t<OPTION>("-u", "dump diagnostic", [](OPTION& o, const char* param) -> void { o.dump_diagnostic = true; }).optional()
                << t_cmdarg_t<OPTION>("-b", "skip basic encoding", [](OPTION& o, const char* param) -> void { o.skip_cbor_basic = true; }).optional()
                << t_cmdarg_t<OPTION>("-g", "skip self-generated message", [](OPTION& o, const char* param) -> void { o.skip_gen = true; }).optional();
