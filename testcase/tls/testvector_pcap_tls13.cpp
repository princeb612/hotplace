...
/**
 * @file   testvector_pcap_tls13.cpp
...
const size_t sizeof_pcap_tls13_aes128gcm_sha256 = RTL_NUMBER_OF(pcap_tls13_aes128gcm_sha256);
...
const size_t sizeof_pcap_tls13_aes256gcm_sha384 = RTL_NUMBER_OF(pcap_tls13_aes256gcm_sha384);
...
const size_t sizeof_pcap_tls13_aes128ccm_sha256 = RTL_NUMBER_OF(pcap_tls13_aes128ccm_sha256);
...
const size_t sizeof_pcap_tls13_chacha20_poly1305 = RTL_NUMBER_OF(pcap_tls13_chacha20_poly1305);
