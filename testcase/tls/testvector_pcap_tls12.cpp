...
/**
 * @file   testvector_pcap_tls12.cpp
...
const pcap_testvector pcap_tls12etm_aes128cbc_sha256[] = {
    ...
    // S->C, server_hello, certificate, server_key_exchange, server_hello_done
    {
        ...
        "00 00 00 16 00 00 00 17 00 00 16 03 03 03 6a 0b"
        ...
        "04 99 e5 56 32 ba 02 fd 72 16 03 03 01 2c 0c 00"
        "01 28 03 00 1d 20 8e 93 3b 4c a7 02 61 06 89 0b"
        "e2 d0 3e 0e 05 64 a7 37 9e b8 b9 0b 5b 3d 68 2c"
        "55 f4 a5 ef 46 67 08 04 01 00 50 ec 45 47 75 24"
        "3b 9c af e9 2f 3a af 50 bb aa 85 f0 67 5c b6 cd"
        "12 e6 7d 01 1a 3f a5 f4 0a 38 a2 4b 7d 90 b1 3f"
        "7e 41 3b c6 d2 e0 c6 97 39 6f 22 aa 2b ee 09 d6"
        "83 b9 ab 77 c0 a4 63 e8 cb f2 0a 67 1d 72 71 b8"
        "7a a9 36 b4 90 ad 6d 22 25 01 ee 52 3b ce b9 56"
        "8b f6 46 38 cf d9 dc d5 30 8e 3c aa e8 05 d7 05"
        "c4 bb 25 33 43 8f a7 5c 72 a6 c1 c1 f9 3d 89 a8"
        "9c b2 15 86 82 11 0e 1f 9c 00 12 6f cd 64 01 57"
        "08 fa 5a 85 f6 5a be 58 e4 18 20 79 d8 13 6a cf"
        "9a 3a 81 b7 ba 08 e4 4c ed e6 53 f9 f9 a5 7d 25"
        "27 b7 84 a2 73 86 83 fe 28 d5 50 c4 ad c6 c2 10"
        "24 f7 89 ec b1 18 a7 75 84 ef d5 52 08 dc 6d 74"
        "0e 99 a7 2e 0b cf af 85 3b c7 15 a3 52 29 26 19"
        "d0 cf fc 29 f2 1d d8 59 b1 5d 4a 54 2b 9e 1e dd"
        "52 fe d8 74 a2 78 ca f5 1b c8 3a c1 06 16 ad 35"
        "4a 84 be 16 2b c6 10 a8 b2 f7 16 03 03 00 04 0e"
        "00 00 00",
    },
    // C->S, client_key_exchange, change_cipher_spec, finished
    {
        ...
        "16 03 03 00 25 10 00 00 21 20 86 be ac 52 20 97"
        "62 d5 c1 50 61 5c 9b c5 ba b2 11 89 6c 70 a2 e8"
        "21 27 b8 80 f4 a1 b1 03 3a 28 14 03 03 00 01 01"
    ...
    {
        from_server,
        "#10 new_session_ticket, change_cipher_spec, finished",
        "16 03 03 00 ba 04 00 00 b6 00 00 1c 20 00 b0 96"
        "67 2d fe 2d c6 99 a8 e9 d1 0f 5a 23 4b 99 af 2a"
        "f6 45 88 e7 d5 34 6c 9c 09 62 46 73 32 9a dc a9"
        "e8 0b 1c f0 77 b2 e7 cf e8 a1 2c c9 39 34 31 9a"
        "af b1 95 e3 b8 4d 78 96 d1 7d 12 4d c6 d7 72 34"
        "1d 3c e5 56 07 f1 92 a2 4a ed 9e cb 0a b3 e6 ea"
        "a5 4b fb 14 5e 2f 93 e6 0e 1b 04 9c c1 54 64 4b"
        "c3 b5 d0 50 0a 59 19 9e 42 5a 7f e7 ac 80 f7 c7"
        "2f 06 74 50 3d 5b 2d 34 a5 4f e6 2a 14 74 42 91"
        "a0 4c 51 00 7a e1 41 e2 b5 c2 a0 8b 25 a6 8e 64"
        "fd 4a 82 21 22 ff 76 eb 72 ce ed 26 80 d7 13 27"
        "48 cd d1 da 89 d8 fc d8 fe 47 0b 4c 5c 93 b0 14"
        "03 03 00 01 01 16 03 03 00 50 aa 69 b7 80 25 eb"
        "0b 3d f4 0c 35 dc 01 a8 95 fc d2 53 66 af 6b b1"
        "83 46 a7 27 5f 5c 48 2d 62 39 80 c2 b3 84 20 c1"
        "ea ba bb b2 08 2a 41 c9 e1 e1 29 a5 ce c9 a8 66"
        "eb f1 f8 ef e4 e5 62 86 be e2 8a b6 c6 93 42 92"
        "4f 2b 76 91 e7 9e 40 f4 33 31",
    },
    // C->S application data
    {
        from_client,
        "#12 application data",
        "17 03 03 00 40 94 b3 62 f1 1e 8d 44 5d 51 bb 33"
        "6b bd 23 65 75 f8 7e b6 4f 32 e9 fe 23 16 a3 7f"
        "05 5f 6f 54 66 49 a0 05 59 df e3 9d 94 d8 82 9f"
        "85 e7 76 49 14 73 48 d7 e3 9e 02 e3 f6 20 f8 d7"
        "b2 95 09 c0 6a",
    },
    // C->S alert
    {
        from_client,
        "#14 alert",
        "15 03 03 00 40 61 43 21 ca 8f 02 65 10 a4 d4 b4"
        "4a 0c 85 41 9f cc c6 f6 95 4c 21 3e e2 13 12 6b"
        "29 47 3e 3f d6 17 9f cd f2 81 0c 1b 6c ef 28 5c"
        "d2 e7 1a 97 2f d0 96 ac 0e 98 f7 d3 ae ee 48 1b"
        "c5 c1 7d b1 88",
    },
    // S->C alert
    {
        from_server,
        "#18 alert",
        "15 03 03 00 40 57 61 d6 68 76 c5 bd b4 bc 5d 3d"
        "c6 67 3b db 44 96 67 0d 24 2e 67 6d 23 24 f5 75"
        "4c 67 be e5 57 11 54 29 00 85 c6 0d 43 83 a6 67"
        "fe b8 b2 58 a2 26 1b 9b ec dc eb 52 6e 49 c0 a1"
        "1f 93 e5 d6 ea",
    },
};
...
const pcap_testvector pcap_tls12mte_aes128cbc_sha256[] = {
    // C->S, client_hello
    {
        from_client,
        "#4 client_hello",
        "16 03 03 00 cc 01 00 00 c8 03 03 88 06 aa f3 ba"
        "b7 cf a0 06 49 7e f5 06 20 dd ae 53 20 bf 15 41"
        "d2 d2 a9 7a fb 85 14 5a a1 d2 75 20 b4 81 ac d6"
        "e0 a2 2e 0f a5 d6 0d b9 fd 2d 02 3c 32 fb 20 89"
        "4a 64 af 87 4e 7a 68 4f df 4f 6f 5a 00 10 c0 23"
        "c0 24 c0 27 c0 28 c0 2b c0 2c c0 2f c0 30 01 00"
        "00 6f 00 0b 00 02 01 00 00 0a 00 0c 00 0a 00 1d"
        "00 17 00 1e 00 19 00 18 00 0d 00 1e 00 1c 04 03"
        "05 03 06 03 08 07 08 08 04 01 05 01 06 01 08 09"
        "08 0a 08 0b 08 04 08 05 08 06 00 2b 00 03 02 03"
        "03 00 2d 00 02 01 01 00 33 00 26 00 24 00 1d 00"
        "20 ab a4 8c ab ab 5b e5 92 54 cc 25 c8 b3 67 ae"
        "0d 35 8b 69 1f 3b 98 d0 4b 5c 67 3b 55 f0 d2 91"
        "57",
    },
    // S->C, server_hello, certificate, server_key_exchange, server_hello_done
    {
        from_server,
        "#6 server_hello, certificate, server_key_exchange, server_hello_done",
        "16 03 03 00 54 02 00 00 50 03 03 e7 36 be 0b f5"
        "e6 d9 ff ec 34 8b 1d 22 2e 5e 5f 0d d2 d4 a4 6c"
        "99 ae 52 1d e3 54 08 88 72 ca ab 20 37 9e f9 6b"
        "1c 03 10 52 81 88 10 c9 2b 67 f0 b7 f9 e0 5f 7b"
        "d4 e2 e8 aa ed ff 4d 55 d8 7d a7 77 c0 27 00 00"
        "08 00 0b 00 04 03 00 01 02 16 03 03 03 6a 0b 00"
        ...
        "28 03 00 1d 20 f4 29 00 ff 3d 69 88 1d a1 44 60"
        "74 0f ac 51 a0 4c b5 ef 3f fd eb ff 76 63 6e 9c"
        "5d fe 3d 31 2b 04 01 01 00 4d 94 81 0f dd 66 c6"
        "7a fd 9b b4 22 eb 76 b7 db 28 4b ad 39 00 d5 f7"
        "e5 7a 41 db d9 30 72 b4 c5 b9 09 ed 75 c1 ed 72"
        "e2 15 6f 3f d0 4b 81 46 fb 7a ae 8c c3 c3 10 16"
        "f2 71 69 ce 4e d2 84 49 2c 40 37 0e b9 60 60 36"
        "ce 66 2c 05 f1 a3 59 e5 6d 4d 06 bd 72 7d eb c2"
        "72 2e 1b 55 85 51 1f 03 55 68 6d 6d a8 ea 96 be"
        "a6 20 eb 08 24 e5 a8 86 18 0a 06 58 37 da 81 e0"
        "ea 9e 05 6c 2c cf 76 4b 29 fe 52 f4 6a a6 fa b8"
        "d9 81 db eb 08 db c4 80 c2 1d 04 b1 fb 7c 5c b2"
        "73 bf 06 c8 61 7d 18 bb f8 2b 02 68 9b 52 e2 fa"
        "ca 74 3d 07 dd eb 0c 59 24 61 c2 21 5e 09 12 4e"
        "db 7e 2e d4 d7 bc d6 2b 21 b7 d7 ce b1 65 f8 0e"
        "2f ec 8c 36 c4 5a 03 3a 13 57 6d 2b 15 df 65 29"
        "75 41 e0 1d a0 82 ba ee 12 45 8a e8 57 75 6d 85"
        "3e c2 d3 dc 5a 69 f7 d5 34 12 51 67 98 2d a0 f1"
        "81 41 12 1c f6 41 f1 a0 09 16 03 03 00 04 0e 00"
        "00 00",
    },
    // C->S, client_key_exchange, change_cipher_spec, finished
    {
        from_client,
        "#8 client_key_exchange, change_cipher_spec, finished",
        "16 03 03 00 25 10 00 00 21 20 c7 34 68 18 ac 64"
        "38 c9 5a 9a 50 38 1d 70 0e 21 ca a9 0c 91 22 ea"
        "8e 15 e6 bf cc aa dd 7e 80 23 14 03 03 00 01 01"
        "16 03 03 00 50 03 b6 79 08 6a b0 11 61 c3 db 15"
        "1d 62 b7 75 50 f1 e8 2e e2 82 85 1b 22 73 b6 05"
        "df e8 c4 40 f8 86 b1 4d ce 29 32 f6 74 35 2f f5"
        "3a f5 8c 60 0b bb 8e af 45 57 bd 31 66 3b 55 33"
        "d1 59 57 3b 50 94 dc c4 9d 51 98 15 6b 9e 49 72"
        "76 59 eb 23 f7",
    },
    // S->C change_cipher_spec, finished
    {
        ...
        "14 03 03 00 01 01 16 03 03 00 50 cb 3a 05 2d 43"
        "3e e8 bb 9f 8a 50 d8 3d 97 b9 0f 44 e1 06 b3 e4"
        "26 87 a7 37 14 d9 b4 e7 80 69 60 b0 c7 17 ce cb"
        "aa 8e e9 3d a0 08 e3 8e 59 b7 52 67 96 c6 9f f2"
        "f5 c7 c0 18 32 d2 27 9d cc 44 e1 b1 56 a8 1a 17"
        "ae 8b 55 7e c2 b7 1b 3f 03 e2 ca",
    },
    // C->S application data
    {
        from_client,
        "#12 application data",
        "17 03 03 00 40 a7 99 3a d1 45 c1 8e 6f 25 14 16"
        "71 a3 56 d6 81 df 39 1e 62 10 68 9a 8e 7e bd 5a"
        "4c 67 fa fa f4 9d 1e 9f 91 4d 11 d2 01 ff ac b6"
        "08 97 91 45 ac 88 78 af be 99 af 03 a8 81 d2 2c"
        "a4 fb ac 35 c8",
    },
    // C->S alert
    {
        from_client,
        "#14 alert",
        "15 03 03 00 40 48 61 45 6b a1 a0 c2 7a 29 d5 2e"
        "13 26 53 9b 13 cc a1 5d ee ca ea af bb a6 15 7c"
        "f7 0f d2 c0 38 c5 a1 be 8a 39 63 be af da b1 1a"
        "61 20 62 7c d4 29 3b 0b 14 45 96 7e 5d 4f 21 24"
        "2f 19 2e 34 23",
    },
    // S->C alert
    {
        from_server,
        "#16 alert",
        "15 03 03 00 40 06 ef 55 b7 23 a5 c9 61 8c 0e 76"
        "89 3f 14 4f e3 e6 29 0c 39 99 f2 be a2 32 a8 f4"
        "d0 fc 79 38 ef 2f e6 2d d8 9f c2 82 19 a5 04 95"
        "31 04 b5 28 7f 4e 36 7c 74 40 4a eb fa fe c6 98"
        "60 0c f4 a4 d6",
    },
};
