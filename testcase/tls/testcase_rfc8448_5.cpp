...
void testcase_rfc8448_5() {
    ...
    }
    {
        ...
        constexpr char constexpr_server[] = KID_TLS_CLIENTHELLO_KEYSHARE_PRIVATE;
        const char* priv =
    ...
    }
    {
        ...
        const char* record =
            ...
            "04";
        binary_t bin_record = base16_decode_rfc(record);
        dump_record("server_hello", &session, from_server, bin_record, false);
    }
    {
