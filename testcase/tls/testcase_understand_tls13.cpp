...
/**
 * @file   testcase_understand_tls13.cpp
...
void test_tls13_xargs_org() {
     ...
     */
    {
        ...
        binary_t bin_record = std::move(base16_decode_rfc(record));
        dump_record("change cipher spec", &session, from_server, bin_record);
    }
     ...
     */
    {
        ...
        binary_t bin_record = std::move(base16_decode_rfc(record));
        dump_record("wrapped-record (encrypted_extensions)", &session, from_server, bin_record);
     ...
     */
    {
        ...
        binary_t bin_record = std::move(base16_decode_rfc(record));
        dump_record("wrapped-record-2 (certificate)", &session, from_server, bin_record);
     ...
     */
    {
        ...
        //  > len 0x0100(256)
        dump_record("wrapped-record-3 (certificate_verify)", &session, from_server, bin_record);
     ...
     */
    {
        ...
        binary_t bin_record = std::move(base16_decode_rfc(record));
        dump_record("wrapped-record-4 (finished)", &session, from_server, bin_record);
     ...
     */
    {
        const char* record = "14 03 03 00 01 01";
        binary_t bin_record = std::move(base16_decode_rfc(record));
        dump_record("client-change-cipher-spec", &session, from_client, bin_record);
    }
    /**
     * C -> S
     ...
     */
    {
        ...
        binary_t bin_record = std::move(base16_decode_rfc(record));
        dump_record("wrapped-record-5 (finished)", &session, from_client, bin_record);
    }
    /**
     * C -> S
     ...
     */
    {
        ...
        binary_t bin_record = std::move(base16_decode_rfc(record));
        dump_record("wrapped-record-6 (ping)", &session, from_client, bin_record);
    }
    /**
     * C <- S
     ...
     */
    {
        ...
        binary_t bin_record = std::move(base16_decode_rfc(record));
        dump_record("wrapped-record-7 (new_session_ticket)", &session, from_server, bin_record);
    }
    /**
     * C <- S
     ...
     */
    {
        ...
        binary_t bin_record = std::move(base16_decode_rfc(record));
        dump_record("wrapped-record-8 (new_session_ticket)", &session, from_server, bin_record);
    }
    /**
     * C <- S
     ...
     */
    {
        ...
        binary_t bin_record = std::move(base16_decode_rfc(record));
        dump_record("wrapped-record-9 (pong)", &session, from_server, bin_record);
    }
}

void testcase_understand_tls13() { test_tls13_xargs_org(); }
