...
void testcase_rfc8448_7() {
    ...
    }
    {
        ...
        test_keycalc(&session, tls_secret_t::handshake, bin, "handshake", "f91761354a67e9b07c6dcc3a55707efa69c4519d8040e5f215121e0df69afa4a");
        // {server}  derive secret "tls13 c hs traffic"
        test_keycalc(&session, tls_secret_t::c_hs_traffic, bin, "c hs traffic", "2c3cb24a1081edb59518ee6861e89a6b72b3801afe7713e4cbbc21c0795bf831");
        // {server}  derive secret "tls13 s hs traffic"
        test_keycalc(&session, tls_secret_t::s_hs_traffic, bin, "s hs traffic", "cace3d555cc1c577cf970cff28cf978d6a9800085442e18d695b50f3151d18c8");
        // {server}  derive secret for master "tls13 derived"
        test_keycalc(&session, tls_secret_t::application_derived, bin, "application_derived", "5da12dc47835ba73fdd994b14ab7e63cc63f0d79162f6756e9a46756c8b2b642");
        // {server}  derive write traffic keys for handshake data
        test_keycalc(&session, tls_secret_t::handshake_server_key, bin, "handshake_server_key", "041091fdab29f2c8abfb156dc5fc8d54");
        test_keycalc(&session, tls_secret_t::handshake_server_iv, bin, "handshake_server_iv", "7464d791685de05998fcbadb");
    }
    {
    ...
    }
    {
        ...
        test_keycalc(&session, tls_secret_t::c_ap_traffic, bin, "c ap traffic", "743e4c6b56cf3909d1b06d01956ccd2c4b37758449aec41d98dae44924eaa299");
        // {server}  derive secret "tls13 s ap traffic"
        test_keycalc(&session, tls_secret_t::s_ap_traffic, bin, "s ap traffic", "b6b8144aa335ed3059c0c9c8f0ecabf7afc94af6643bdecdfd9210188fab7451");
        // {server}  derive secret "tls13 exp master"
        test_keycalc(&session, tls_secret_t::exp_master, bin, "exp master", "fb69121cea334db459e12272d179baca2369b643d11a6ac72b8b27a5c964feb1");
        // {server}  derive write traffic keys for application data
        test_keycalc(&session, tls_secret_t::application_server_key, bin, "application_server_key", "edc4cbd0041c28cc7167441d7ca53e6a");
        test_keycalc(&session, tls_secret_t::application_server_iv, bin, "application_server_iv", "bf6c7d8e0a9545b427dcf139");
        // {server}  derive read traffic keys for handshake data
        test_keycalc(&session, tls_secret_t::handshake_client_key, bin, "handshake_client_key", "62d13c13ffd7402fc1c09e3d163665cb");
        test_keycalc(&session, tls_secret_t::handshake_client_iv, bin, "handshake_client_iv", "7166f20028bf146dcfbd5a40");
    ...
    }
    {
        ...
        test_keycalc(&session, tls_secret_t::application_client_key, bin, "application_client_key", "33d7f9709756c966488ad4438437e673");
        test_keycalc(&session, tls_secret_t::application_client_iv, bin, "application_client_iv", "c5f30d34b0e91b7d6c8eea65");
        // {client}  derive secret "tls13 res master"
        test_keycalc(&session, tls_secret_t::res_master, bin, "res master", "0b5d4407cea0a42a3a81dd477647b7fe9180db297e5114f1ad8796b4dc475004");
    }
    {
        const char* record =
