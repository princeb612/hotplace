...
/**
 * @file   testvector_cbchmac_tls.cpp
...
test_vector_cbchmac_tls_t test_vector_tls_mte[] = {
    {
...
const size_t sizeof_test_vector_tls_mte = RTL_NUMBER_OF(test_vector_tls_mte);
...
test_vector_cbchmac_tls_t test_vector_tls_etm[] = {
    ...
    {
        // wireshark capture (using netclient debugging info)
        "client finished",
        tls_encrypt_then_mac,
        sha2_256,
...
const size_t sizeof_test_vector_tls_etm = RTL_NUMBER_OF(test_vector_tls_etm);
